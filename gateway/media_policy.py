...
from environment variables:
  ...
  - ``NASTECH_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``NASTECH_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``NASTECH_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``nastech cron run`` in the CLI, ``nastech send``, a
...
_STRICT_ENV = "NASTECH_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "NASTECH_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "NASTECH_MEDIA_TRUST_RECENT_FILES"
