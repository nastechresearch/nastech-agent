...
class GatewayAuthorizationMixin:
    ...
    def _authorization_adapter(
        ...
        ``_profile_runtime_scope``, which overrides ``NASTECH_HOME`` so
        ...
        if profile_name and profile_name != "default":
            ...
            # reads the per-turn NASTECH_HOME override, so inside a secondary
    ...
    def _adapter_group_has_sender_allowlist(
        ...
        *,
        ...
        restricting which senders inside that group can invoke Nastech. If such a
    ...
    def _is_user_authorized(
        ...
        *,
        ...
        # (nastech gateway pairing approve / the authenticated dashboard) — an
        ...
        # (``load_nastech_dotenv(override=True)`` in
