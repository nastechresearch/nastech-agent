...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Nastech session"),
        ...
        _cmd("status", "Show Nastech session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Nastech agent"),
        ...
        _cmd("update", "Update Nastech Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Nastech gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Nastech session in it",
