...
the same three things: what Nastech wants to run, why it was flagged, and that silence means
...
EA_HEADER_TEXT = "Nastech wants to run a command that needs your OK"
