...
from gateway.platforms.yuanbao_proto import (
    CMD_TYPE, WS_HEARTBEAT_RUNNING, WS_HEARTBEAT_FINISH, NASTECH_INSTANCE_ID,
...
_APP_VERSION = _BOT_VERSION = _NASTECH_VERSION
...
class YuanbaoAdapter(BasePlatformAdapter):
    ...
    # Per Nastech home: a multiplexed gateway runs one Yuanbao adapter per profile, and the tools /
    ...
    def get_active(cls) -> Optional["YuanbaoAdapter"]:
        ...
        return cls._active_instances.get(nastech_home_key())
    ...
    def set_active(cls, adapter: Optional["YuanbaoAdapter"]) -> None:
        ...
        if get_nastech_home_override() is None:
            ...
            cls._active_instances.pop(nastech_home_key(), None)
        else:
            cls._active_instances[nastech_home_key()] = adapter
