...
# `require_mention: true` without custom aliases uses Nastech wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?nastech\s+agent\b[,:\-]?", r"(?<![\w@])@?nastech\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Nastech defaults)."""
