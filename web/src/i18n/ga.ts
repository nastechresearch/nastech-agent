...
export const ga: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Bain an plugin seo ó ~/.nastech/plugins/?",
    removeHint: "Ní féidir ach plugins atá suiteáilte ag an úsáideoir faoi ~/.nastech/plugins a bhaint.",
  ...
  skills: {
    ...
    filters: "Scagairí",
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.nastech/skills/",
