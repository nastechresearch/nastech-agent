...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    catalogHint:
      "Curated, Nastech-reviewed plugins pinned to exact commits. Install from here for supply-chain-safe versions.",
    catalogSearchPlaceholder: "Search catalog...",
    catalogEmpty: "No catalog entries match.",
    catalogEmptyDocsLink: "Learn about Nastech plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills installed yet. Browse the skills hub or create one here; from a terminal you can also run `nastech skills search <topic>`.",
