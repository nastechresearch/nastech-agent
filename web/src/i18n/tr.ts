...
export const tr: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Bu eklenti ~/.nastech/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.nastech/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.nastech/skills/ adresinden yüklenir",
