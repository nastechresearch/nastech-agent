import { parseColor, THEME_PRESET_PALETTES, type ThemePresetPalette } from "@nastech/shared";
 ...
 * take their colours from `@nastech/shared` `THEME_PRESET_PALETTES` so both
