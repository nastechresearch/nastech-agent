...
/** Preflight for `nastech gateway migrate --multiplex` (mirrors the CLI plan JSON). */
...
export interface StatusResponse {
  ...
  /** NS-656: disk-usage rollup for the NASTECH_HOME volume. Absent on
   * older gateways. */
 ...
 * sample of the NASTECH_HOME volume — no staleness dimension, so no
 * sampled_at. */
