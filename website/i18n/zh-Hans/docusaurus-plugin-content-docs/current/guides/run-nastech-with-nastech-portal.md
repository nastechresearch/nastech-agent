...
本指南带你从头到尾完成在 [Nastech Portal](https://portal.nastechresearch.github.io) 订阅下运行 Nastech Agent 的全过程——从注册账号到验证每个工具的路由是否正确。如果你只想了解 Portal 的概述及订阅内容，请参阅 [Nastech Portal 集成页面](/integrations/nastech-portal)。本页是操作步骤脚本。
