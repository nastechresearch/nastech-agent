...
const config: Config = {
  ...
  url: 'https://nastech-agent.nastechresearch.com',
  baseUrl: '/docs/',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NastechResearch/nastech-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/nastech-agent-banner.png',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://nastech-agent.nastechresearch.com/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/NastechResearch/nastech-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/NastechResearch',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/NastechResearch' },
            { label: 'GitHub Issues', href: 'https://github.com/NastechResearch/nastech-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://nastech-agent.nastechresearch.com/' },
