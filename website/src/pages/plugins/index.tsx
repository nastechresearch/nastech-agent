...
const CATALOG_README_URL =
  "https://github.com/NastechResearch/nastech-agent/tree/main/plugin-catalog";
...
// nastech_cli/plugin_catalog.py and website/scripts/extract-plugins.py.
const CATEGORY_CONFIG: Record<string, { label: string; icon: string; blurb: string }> = {
  desktop: { label: "Desktop", icon: "\u{1F5A5}\u{FE0F}", blurb: "Panes, tabs and views for Nastech Desktop" },
      ...
      <div className={styles.cardInner}>
        ...
        {expanded && (
          <div className={styles.cardDetail}>
            ...
            {plugin.requiresNastech && (
              <div className={styles.metaRow}>
                <span className={styles.metaLabel}>Requires</span>
                <span className={styles.metaValue}>
                  <code>nastech {plugin.requiresNastech}</code>
                </span>
              </div>
            )}
            <div className={styles.metaRow}>
...
export default function PluginCatalogPage() {
  ...
  // (Nastech desktop's Capabilities > Plugins tab) as a one-click catalog
  // picker. Site chrome is hidden via CSS and every card gains an
  // "+ Add to this Agent" button that posts
  //   { type: 'nastech-plugin-pick', name, repo, sha, subdir, tier,
  //     installCmd }
    ...
    window.parent.postMessage(
      {
        ...
        tier: plugin.tier,
        installCmd: plugin.installCommand || `nastech plugins install ${plugin.name}`,
      },
      "*"
    );
  }, []);
  ...
  return (
    <Layout
      ...
      description="Browse reviewed, SHA-pinned plugins for Nastech Agent"
    >
        ...
        <header className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSub}>
              Reviewed, SHA-pinned plugins. Open in Nastech Desktop to review and install, or copy the CLI command.
              {loadError && (
          ...
          {!data && !loadError ? (
            ...
            <div className={styles.empty}>
              ...
              <p className={styles.emptyDesc}>
                The plugin catalog is a curated, human-reviewed list of Nastech
