...
The native [Nastech Desktop](/user-guide/desktop) app is contribution-driven: every
...
CLI/gateway plugins are documented at [Build a Nastech Plugin](/developer-guide/plugins).
...
```javascript
import { Contribute, TITLEBAR_AREAS } from '@nastech/plugin-sdk'
