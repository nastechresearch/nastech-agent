...
| [`nastech-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nastech-agent) | Use, configure, theme, extend, and orchestrate Nastech Agent. | `autonomous-ai-agents\nastech-agent` |
...
| [`nastech-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-nastech-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\nastech-agent-skill-authoring` |
