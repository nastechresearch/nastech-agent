...
| [`nastech-agent`](../user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nastech-agent.md) | Use, configure, theme, extend, and orchestrate Nastech Agent. | `autonomous-ai-agents\nastech-agent` |
...
| [`nastech-agent-skill-authoring`](../user-guide/skills/bundled/software-development/software-development-nastech-agent-skill-authoring.md) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\nastech-agent-skill-authoring` |
| [`inspecting-nastech-desktop-dom`](../user-guide/skills/bundled/software-development/software-development-inspecting-nastech-desktop-dom.md) | Read the live Nastech desktop DOM/CSS over CDP. | `software-development\inspecting-nastech-desktop-dom` |
