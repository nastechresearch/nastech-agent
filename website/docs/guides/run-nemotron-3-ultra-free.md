...
[Download the Nastech Desktop installer](https://nastech-agent.nastechresearch.com/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).
...
Prefer to review first? Download [`install.sh`](https://nastech-agent.nastechresearch.com/install.sh), inspect it, then run it.
