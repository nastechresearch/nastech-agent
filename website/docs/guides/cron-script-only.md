...
| OS cron + `curl` to a [webhook subscription](../user-guide/messaging/webhooks.md) | Your script on the OS schedule | When Nastech might be unhealthy (the thing you're monitoring) |
