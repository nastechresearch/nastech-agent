...
```bash
python ~/.nastech/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.nastech/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.nastech/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
