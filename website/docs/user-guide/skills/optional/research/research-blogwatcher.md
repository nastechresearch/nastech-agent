...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/research/blogwatcher` |
...
## Working with Nastech tools (read this first)

`blogwatcher-cli` is the feed database; Nastech tools do the automation around it:
