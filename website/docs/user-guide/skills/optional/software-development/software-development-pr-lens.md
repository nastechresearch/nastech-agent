...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/software-development/pr-lens` |
| Path | `optional-skills/software-development/pr-lens` |
| Version | `1.0.0` |
| Author | Coldtea AI (adapted by Nastech Research) |
| License | MIT |
