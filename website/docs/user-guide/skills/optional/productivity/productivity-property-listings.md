...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the Nastech desktop transcript.
...
- A Nastech desktop conversation for native cards; the backend may be local or remote.
...
```text
nastech skills install official/productivity/property-listings
```
