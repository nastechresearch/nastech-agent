...
| | |
|---|---|
| Source | Optional — install with `nastech skills install official/creative/impeccable` |
...
> ships and verifies a Nastech-native skill bundle under `.nastech/skills/`.
> `nastech skills install impeccable` pulls the current bundle live from that
