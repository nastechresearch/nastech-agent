...
:::tip
Inside the container, run `nastech setup --portal` once — the refresh token persists in the mounted `~/.nastech` volume. See [Nastech Portal](../integrations/nastech-portal.md).
:::
...
use `*`, `0.0.0.0/0`, or `::/0`; Nastech rejects those unbounded entries.
