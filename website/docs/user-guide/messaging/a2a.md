...
```bash
nastech tools enable a2a --platform cli        # CLI/TUI sessions
nastech tools enable a2a --platform telegram   # or any messaging platform
nastech tools enable a2a --platform a2a        # let inbound A2A tasks call peers (agent chaining)
```
