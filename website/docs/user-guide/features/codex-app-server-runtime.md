...
:::tip
Not using OpenAI Codex? `nastech setup --portal` configures a non-Codex backend with Claude/Gemini/etc. in one step. See [Nastech Portal](../../integrations/nastech-portal.md).
:::
