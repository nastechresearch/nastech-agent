...
```bash
curl -fsSL https://nastech-agent.nastechresearch.com/install.sh | bash -s -- --no-skills
```
...
[Skills Hub](https://nastech-agent.nastechresearch.com/docs) page — instead of a
