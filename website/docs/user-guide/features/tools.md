...
See [Toolsets Reference](../../reference/toolsets-reference.md) for the full set, including platform presets such as `nastech-cli`, `nastech-telegram`, and dynamic MCP toolsets like `mcp-<server>`.
...
Nastech keeps the newest **64 completed results**, for up to **7 days after
completion**, under `logs/process-results/` in the profile's Nastech home. Each
