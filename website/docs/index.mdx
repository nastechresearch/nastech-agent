...
slug: /
sidebar_position: 0
title: "Nastech Agent Documentation"
description: "The self-improving AI agent built by Nastech Research. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Nastech Research](https://nastechresearch.github.io). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `nastech setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nastech Portal](./integrations/nastech-portal.md).
:::

## What is Nastech Agent?
...
| 🔌 **[MCP Integration](./user-guide/features/mcp.md)**                      | Connect to MCP servers, filter their tools, and extend Nastech safely  |
| 🧭 **[Use MCP with Nastech](./guides/use-mcp-with-nastech.md)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](./user-guide/features/voice-mode.md)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Nastech](./guides/use-voice-mode-with-nastech.md)** | Hands-on setup and usage patterns for Nastech voice workflows          |
| 🎭 **[Personality & SOUL.md](./user-guide/features/personality.md)**        | Define Nastech' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](./guides/tips.md)**                            | Quick wins to get the most out of Nastech                              |
...
- **Built by model trainers** — Created by [Nastech Research](https://nastechresearch.github.io), the lab behind Nastech, Nomos, and Psyche. Works with [Nastech Portal](https://portal.nastechresearch.github.io), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Nastech Portal](./integrations/nastech-portal.md) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nastech Research](https://nastechresearch.github.io) — the lab behind Nastech, Nomos, and Psyche models
