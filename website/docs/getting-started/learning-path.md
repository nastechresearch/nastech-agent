...
:::tip Start Here
If you haven't installed Nastech Agent yet, begin with the [Installation guide](./installation.md) and then run through the [Quickstart](./quickstart.md). Everything below assumes you have a working installation.
:::

:::tip First-time provider setup
First-time users almost always want `nastech setup --portal` — one OAuth covers a model plus the four Tool Gateway tools (search/image/TTS/browser). See [Nastech Portal](../integrations/nastech-portal.md).
:::
...
7. [Use Voice Mode with Nastech](../guides/use-voice-mode-with-nastech.md)
...
2. [Build a Nastech Plugin](../developer-guide/plugins/index.md)
...
| **Code Execution** | Run Python scripts that call Nastech tools programmatically | [Code Execution](../user-guide/features/code-execution.md) |
