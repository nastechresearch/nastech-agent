...
Both publish at:
  https://nastech-agent.nastechresearch.com/docs/llms.txt
  https://nastech-agent.nastechresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://nastech-agent.nastechresearch.com/docs"
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "backends. Works with Nastech Portal, OpenRouter, OpenAI, Anthropic, Google, or any "
        "OpenAI-compatible endpoint."
    )
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/NastechResearch/"
        "nastech-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NastechResearch/nastech-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://nastech-agent.nastechresearch.com/docs\n",
        "Short index: https://nastech-agent.nastechresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
