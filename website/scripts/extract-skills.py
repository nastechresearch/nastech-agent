...
2. The unified Nastech Skills Index at ``website/static/api/skills-index.json``,
    ...
    for base_dir, source_label in LOCAL_SKILL_DIRS:
        ...
        for root, _dirs, files in os.walk(base_path):
            ...
            install_identifier = (
                ...
                else f"NastechResearch/nastech-agent/skills/{rel_id}"
            )
            skills.append({
                ...
                "installCmd": f"nastech skills install {install_identifier}",
            })
...
def extract_unified_index_skills():
    ...
    for entry in data.get("skills", []):
        ...
        out.append({
            ...
            "installIdentifier": install_cmd.removeprefix("nastech skills install "),
