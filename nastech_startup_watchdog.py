...
timeout. Config is env-only (``NASTECH_STARTUP_WATCHDOG=0``,
``NASTECH_STARTUP_WATCHDOG_TIMEOUT_S``) because config.yaml parsing is itself in scope.
...
# Module singleton: the arm sites (nastech_cli.main / nastech_cli.gateway /
