"""``nastech tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'nastech tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # nastech tools list [--platform cli]
    ...
    # nastech tools disable <name...> [--platform cli]
    ...
    # nastech tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `nastech tools` runs after you pick a provider that\n"
