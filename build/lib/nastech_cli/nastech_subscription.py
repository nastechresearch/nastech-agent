    ...
    *,
    ...
    features = {
        ...
        "image_gen": NastechFeatureState(
            ...
            current_provider="FAL" if direct_fal else ("Nastech Subscription" if image_managed else ""),
        ...
        "video_gen": NastechFeatureState(
            ...
            current_provider="FAL" if direct_fal_video else ("Nastech Subscription" if video_managed else ""),
