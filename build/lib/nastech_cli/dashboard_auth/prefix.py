...
def _warn_if_malformed(source: str, raw: str) -> None:
    ...
    missing scheme (``nastech.example.com`` instead of
    ``https://nastech.example.com``) — the single most common cause of
    "I set NASTECH_DASHBOARD_PUBLIC_URL but the OAuth callback is still
    ...
    _log.warning(
        ...
        source,
        cleaned,
        cleaned.split("://")[-1] or "nastech.example.com",
    )
