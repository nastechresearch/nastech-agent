...
class CodexAppServerSession:
    ...
    def _decide_exec_approval(self, params: dict) -> str:
        ...
        This is protocol-level routing only — it carries NO Nastech
        approval-mode/timeout logic. The Nastech-side resolution happens
    ...
    def _decide_apply_patch_approval(self, params: dict) -> str:
        ...
        Protocol-level routing only; Nastech approval-mode/timeout
...
def _approval_choice_to_codex_decision(choice: str) -> str:
    ...
    NOT in tools/approval.py: the Nastech approval mode/timeout resolution
    ...
    # "prompt expired"; the Nastech-side messaging already distinguishes them.
    return "decline"
