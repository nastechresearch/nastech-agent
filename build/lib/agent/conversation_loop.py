...
def _is_nastech_inference_route(provider: str, base_url: str) -> bool:
    ...
    return (
        base_url_host_matches(base, "inference-api.nastechresearch.com")
    )
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                if (
                    ...
                    print(f"{agent.log_prefix}     • Check credits / billing: https://portal.nastechresearch.com")
                    ...
                    if classified.is_auth or classified.reason == FailoverReason.billing:
                        if classified.reason == FailoverReason.billing and _print_billing_or_entitlement_guidance(
                            ...
                            if _provider == "openai-codex":
                                ...
                                agent._vprint(f"{agent.log_prefix}      2. Check your portal account: https://portal.nastechresearch.com", force=True)
