"""Public, plugin-safe lifecycle API for delegated Nastech subagents.
...
_ACTIVE_PARENT_AGENT: contextvars.ContextVar[Any] = contextvars.ContextVar(
    "nastech_subagent_lifecycle_parent", default=None
)
    ...
    def launch(self, request: SubagentLaunchRequest) -> SubagentHandle:
        ...
        if parent is None:
            raise SubagentLifecycleError(
                "No active Nastech parent session is available."
            )
