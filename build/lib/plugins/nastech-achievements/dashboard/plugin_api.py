...
def state_path() -> Path:
    return get_nastech_home() / "plugins" / "nastech-achievements" / "state.json"


def snapshot_path() -> Path:
    return get_nastech_home() / "plugins" / "nastech-achievements" / "scan_snapshot.json"


def checkpoint_path() -> Path:
    return get_nastech_home() / "plugins" / "nastech-achievements" / "scan_checkpoint.json"
