...
``_check_spotify_available()`` — when the user has not run ``nastech auth
spotify``, the tools remain registered (so they appear in ``nastech
...
The Spotify auth flow (``nastech auth spotify``), CLI plumbing, and docs
