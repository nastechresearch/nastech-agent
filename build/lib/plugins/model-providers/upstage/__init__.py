...
# When the user hasn't picked a reasoning effort, Nastech passes
...
# ON at this effort — matching the "medium (default)" that Nastech' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Nastech' effort vocabulary onto Solar's accepted set. xhigh/max/
