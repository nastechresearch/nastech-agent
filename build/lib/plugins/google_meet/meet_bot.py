...
# and exposes ``window.__nastechMeetDrain()`` to pull new entries. This
...
def _start_realtime_speaker(
    *,
    ...
    if platform_tag == "linux":
        ...
        sink = (bridge_info or {}).get("write_target") or "nastech_meet_sink"
        try:
            proc = _sp.Popen(
                [
                    "paplay",
...
def _detect_admission(page) -> bool:
    ...
    (() => {
      ...
      if (window.__nastechMeetInstalled) {
