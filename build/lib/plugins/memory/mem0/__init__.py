...
Configuration
-------------
Secret (lives in $NASTECH_HOME/.env or the environment):
...
Behavioral settings (live in $NASTECH_HOME/mem0.json, set via `nastech memory
setup`):
  ...
  agent_id           — Agent identifier (default: nastech)
...
def _load_config() -> dict:
    """Load config from env vars, with $NASTECH_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "nastech"),
        "oss": {},
    }
    ...
    config_path = get_nastech_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, nastech_home):
        """Write config to $NASTECH_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $NASTECH_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "nastech")
