...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Nastech session"},
        {
            "name": "model",
        ...
        {"name": "update", "description": "Update Nastech Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Nastech gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Nastech session in it",
