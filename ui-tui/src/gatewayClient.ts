...
import type { GatewayEvent } from '@nastech/shared/gateway-events'
import {
  ...
  type ServerRequest,
  wireFrameText
} from '@nastech/shared/json-rpc-channel'
import { reconnectBackoffDelayMs } from '@nastech/shared/reconnect-backoff'
...
// @nastech/shared's JsonRpcRequestChannel; these re-exports keep the TUI's
