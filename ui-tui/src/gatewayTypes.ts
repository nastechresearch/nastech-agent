import type { BillingBlock, UsageModelData } from '@nastech/shared/billing'
import type { NastechSkin } from '@nastech/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@nastech/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = NastechSkin
...
// Wire shapes now live in @nastech/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
