...
def build_turn_context(
    ...
    *,
    ...
    if (
        ...
        # Nastech only initiates compaction in "nastech" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Nastech preflight compression for codex app-server "
                "(mode=%s); Nastech will not start thread compaction here.",
    ...
    if agent._memory_manager:
        ...
        # to surface it. Rendered by Nastech (via _emit_status), so it always
