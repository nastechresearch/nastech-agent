...
from agent.anthropic_endpoints import (
    _is_deepseek_anthropic_endpoint, _is_kimi_family_endpoint, _is_nastech_portal_endpoint,
...
def _convert_assistant_message(m: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # See nastech-agent#13848. Accept empty string "" — _copy_reasoning_content_for_api() injects "" as a
...
def _manage_thinking_signatures(result: List[Dict[str, Any]], base_url: str | None, model: str | None) -> None:
    ...
    Kimi replays as-is; DeepSeek needs unsigned blocks round-tripped but rejects signed ones. Nastech
    ...
    """
    is_third_party = _is_third_party_anthropic_endpoint(base_url) and not _is_nastech_portal_endpoint(base_url)
