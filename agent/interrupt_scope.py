...
A host that runs a blocking command on a worker thread (Nastech Console) never sees
...
_ACTIVE_SCOPE: ContextVar[Optional["InterruptScope"]] = ContextVar("nastech_interrupt_scope", default=None)
