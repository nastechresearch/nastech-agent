...
def auth_kind(provider: Optional[str]) -> str:
    ...
    try:
        from nastech_cli.provider_catalog import provider_catalog_by_slug
...
def build_error_surface_from_result(result: Any, provider: str = "", model: str = "") -> Optional[dict]:
    ...
    try:
        ...
        # provider stack; nastech_state owns the pattern list.
        ...
        # The Nastech free tier refused or could not serve the turn (``agent/turn_recovery.py``
