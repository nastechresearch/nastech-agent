"""``$NASTECH_HOME/cache/<kind>/`` materialisation helpers for the image/video
...
def cache_dir(kind: str) -> Path:
    """Return ``$NASTECH_HOME/cache/<kind>/``, creating parents as needed."""
    from nastech_constants import get_nastech_home
    path = get_nastech_home() / "cache" / kind
