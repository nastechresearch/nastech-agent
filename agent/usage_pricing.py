...
# onto the base entries so the snapshot stays single-source. The Nastech-side
...
def resolve_billing_route(
    ...
    if provider_name == "nastech" or base_url_host_matches(base_url or "", "inference-api.nastechresearch.github.io"):
