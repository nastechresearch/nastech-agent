...
_FREE_TIER_GUIDANCE = (
    ...
    "for Gemini Flash models). Nastech typically makes 3-10 API calls per user turn, "
...
_STANDARD_KEY_GUIDANCE = (
    ...
    "GOOGLE_API_KEY in ~/.nastech/.env and restart your session. "
...
def _thinking_requests_output_headroom(thinking_config: Any) -> bool:
    ...
    Nastech ``max_tokens`` of 4096/16384 is enough for visible text, but
...
class GeminiNativeClient:
    ...
    # is never re-dispatched through a wire adapter. (No NASTECH_SKIP_ASYNC_WRAP
