"""``nastech lsp`` CLI subcommand: status / list / install / install-all / restart / which.

Handlers live here (not in ``nastech_cli/main.py``) so the LSP module ships self-contained.
"""
