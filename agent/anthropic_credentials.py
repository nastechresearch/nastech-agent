...
def claude_code_credentials_path() -> Path:
    ...
    like the Claude CLI itself (blank = unset, as in ``nastech_cli.foreign_sessions``), so pointing it at an
    empty directory opts a Nastech process out of borrowing the login."""
