...
from agent.auxiliary_unavailable import (
    AuxiliaryClientUnavailable, clear_nastech_credential_failure, nastech_credential_failure_detail,
    record_nastech_credential_failure)
        ...
        if client is None:
            ...
            if _explicit and _explicit not in {"auto", "openrouter", "custom"}:
                ...
                if fb_client is None:
                    ...
                    raise AuxiliaryClientUnavailable(nastech_detail or (
                        ...
                        f"a different provider with `nastech model`."))
