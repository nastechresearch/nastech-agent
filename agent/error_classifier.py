...
# ``data:`` field before Nastech receives a completion chunk.  Keeping this
...
# See: https://github.com/NastechResearch/nastech-agent/issues/69078
...
# case: a stream dies mid-response and Nastech persists a content-less
...
# Request parameters that Nastech sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # nastech_cli.plugins.VALID_HOOKS for the callback contract). Callback
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, Nastech) run before
    ...
    if status_code == 404:
        # Nastech API currently surfaces HA/NAS credit depletion as a paid model
