...
_SESSION_CWD: ContextVar = ContextVar("NASTECH_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Nastech source tree, a
    legitimate workspace when developing Nastech; fallback-directory policy lives in the caller."""
