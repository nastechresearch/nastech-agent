...
providers (OpenRouter, Nastech, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
...
def _reasoning_config_for_model(model: str, reasoning_config: dict | None) -> dict | None:
    ...
    Nastech' internal effort set extends the wire vocabulary with ``ultra``
...
def _raise_gemini_thinking_max_tokens(
    ...
    global Nastech cap of 4096 is enough for visible text, but Ultra/high
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        params (all optional):
            ...
            # Claude on OpenRouter/Nastech max output
        ...
        if tools:
            ...
            # tool parameters here keeps aggregator routes (Nastech, OpenRouter,
        ...
        if is_kimi:
            ...
            if not _kimi_thinking_off:
                ...
                # Nastech' upper-ladder levels 400 or silently degrade. Mirror
                # the kimi-coding plugin's _K3_EFFORT_MAP; older Kimi models
                # keep the low/medium/high vocabulary with the stronger
                # Nastech levels capped at high instead of being dropped
        ...
        if is_tokenhub:
            ...
            if not _tokenhub_thinking_off:
                # TokenHub accepts low/medium/high. Map Nastech' full ladder
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        if extra_body:
            ...
            # This happens when a profile that emits extra_body (e.g. the Nastech
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        if message_tool_calls:
            ...
            for tc in message_tool_calls:
                ...
                # preserve an explicit blank name for Nastech's recovery path.
        ...
        # Bedrock (e.g. Nastech Portal) surface a Claude refusal this way — or via
