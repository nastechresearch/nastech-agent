...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # "ultra" is Nastech-internal ladder vocabulary (the Codex product
        ...
        if params.get("is_xai_responses", False):
            ...
            # out at high. max/ultra are Nastech ladder aliases for "this
        ...
        if (params.get("provider") or "").strip().lower() == "actual":
            ...
            # line 1 column 1"). Clamp Nastech' wider set to the supported one.
