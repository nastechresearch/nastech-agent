...
from nastech_bootstrap import _happy_eyeballs_create_connection
...
NASTECH_TRANSPORT_OWNER_EXT = "nastech_transport_owner"
...
def _shared_transport_cls():
    ...
    class _SharedTransportImpl(httpx.BaseTransport):
        ...
        def handle_request(self, request: Any) -> Any:
            ...
            request.extensions[NASTECH_TRANSPORT_OWNER_EXT] = id(self)
