...
def _managed_local_load_notice(agent, api_kwargs: dict) -> "Optional[str]":
    ...
    try:
        ...
        from nastech_cli.local_runtime.load_progress import (
...
def _build_api_kwargs_for_mode(agent, api_messages: list, tools_for_api: list | None = None) -> dict:
    ...
    _is_nastech = base_url_host_matches(agent._base_url_lower, "nastechresearch.github.io")
...
def handle_max_iterations(agent, messages: list, api_call_count: int) -> str:
    ...
    if getattr(agent, "suppress_status_output", False):
        # Strict machine-readable mode (nastech chat -Q, oneshot, background
    ...
    def _call_chat_completions(stream_attempt_id: int):
        ...
        for chunk in _iter_provider_stream_chunks(
            ...
            if not chunk.choices:
                ...
                # Nastech Portal usage frames often have choices=[] plus
