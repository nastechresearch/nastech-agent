...
# (nastech_state._rows_to_conversation), so any code that mutates a loaded or flushed dict's content in place
...
def _today_for_prompt() -> str:
    ...
    try:
        ...
        # via nastech_time.now(). The compaction summary is a mid-conversation message that is NOT part of
        ...
        return _nastech_now().strftime("%Y-%m-%d")
