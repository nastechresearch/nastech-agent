...
def get_consolidate() -> bool:
    ...
    The explicit ``nastech curator run --consolidate`` flag overrides this for
...
def run_curator_review(
    ...
    *consolidate* gates the LLM umbrella-building pass. ``None`` (the default)
    ...
    ``nastech curator run --consolidate`` flag. When consolidation is off, only
    ...
    try:
        ...
        review_agent = AIAgent(
            ...
            **_agent_kwargs,
            ...
            # followed snapshotted an already-stripped package and ``nastech
