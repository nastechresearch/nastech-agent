...
Standard library only, so it runs in any Nastech environment without an install
...
USER_AGENT = "nastech-agent/1.0 (rss-feeds skill; +https://github.com/NastechResearch/nastech-agent)"
TIMEOUT = 20
NS = {
