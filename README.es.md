...
<p align="center">
  <a href="https://nastech-agent.nastechresearch.com/docs/"><img src="https://img.shields.io/badge/Docs-nastech--agent.nastechresearch.com-FFD700?style=for-the-badge" alt="Documentación"></a>
...
> **Nota:** En Windows nativo, Nastech funciona sin WSL — la CLI, el gateway, la TUI y las herramientas funcionan de forma nativa. Si prefieres usar WSL2, el comando de Linux/macOS de arriba también funciona allí. ¿Encontraste un error? Por favor [crea un issue](https://github.com/NastechResearch/nastech-agent/issues).
...
> **Android / Termux:** La ruta manual probada está documentada en la [guía de Termux](https://nastech-agent.nastechresearch.com/docs/getting-started/termux). En Termux, Nastech instala el extra `.[termux]` curado porque el extra completo `.[all]` actualmente incluye dependencias de voz incompatibles con Android.
>
...
```bash
nastech              # CLI interactiva — inicia una conversación
nastech model        # Elige tu proveedor y modelo LLM
nastech tools        # Configura qué herramientas están habilitadas
nastech config set   # Establece valores de configuración individuales
nastech gateway      # Inicia el gateway de mensajería (Telegram, Discord, etc.)
nastech setup        # Ejecuta el asistente de configuración completo
nastech claw migrate # Migra desde OpenClaw (si vienes de OpenClaw)
nastech update       # Actualiza a la última versión
nastech doctor       # Diagnostica cualquier problema
```

📖 **[Documentación completa →](https://nastech-agent.nastechresearch.com/docs/)**
...
Esto te autentica vía OAuth, establece Nastech como tu proveedor y activa el Tool Gateway. Comprueba qué está conectado en cualquier momento con `nastech portal info`. Detalles completos en la [página de documentación del Tool Gateway](https://nastech-agent.nastechresearch.com/docs/user-guide/features/tool-gateway).
...
| ----------------------------------- | --------------------------------------------- | --------------------------------------------------------------------------------- |
| Empezar a chatear                   | `nastech`                                      | Ejecuta `nastech gateway setup` + `nastech gateway start`, luego envía un mensaje al bot |
...
Para las listas de comandos completas, consulta la [guía de CLI](https://nastech-agent.nastechresearch.com/docs/user-guide/cli) y la [guía del Gateway de Mensajería](https://nastech-agent.nastechresearch.com/docs/user-guide/messaging).

---

## Documentación

Toda la documentación está en **[nastech-agent.nastechresearch.com/docs](https://nastech-agent.nastechresearch.com/docs/)**:

| Sección                                                                                             | Contenido                                                    |
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| [Inicio rápido](https://nastech-agent.nastechresearch.com/docs/getting-started/quickstart)              | Instalar → configurar → primera conversación en 2 minutos   |
| [Uso de CLI](https://nastech-agent.nastechresearch.com/docs/user-guide/cli)                             | Comandos, atajos de teclado, personalidades, sesiones        |
| [Configuración](https://nastech-agent.nastechresearch.com/docs/user-guide/configuration)               | Archivo de configuración, proveedores, modelos, todas las opciones |
| [Gateway de Mensajería](https://nastech-agent.nastechresearch.com/docs/user-guide/messaging)           | Telegram, Discord, Slack, WhatsApp, Signal, Home Assistant   |
| [Seguridad](https://nastech-agent.nastechresearch.com/docs/user-guide/security)                        | Aprobación de comandos, emparejamiento por DM, aislamiento en contenedor |
| [Herramientas y Toolsets](https://nastech-agent.nastechresearch.com/docs/user-guide/features/tools)   | Más de 40 herramientas, sistema de toolsets, backends de terminal |
| [Sistema de Habilidades](https://nastech-agent.nastechresearch.com/docs/user-guide/features/skills)   | Memoria procedimental, Skills Hub, creación de habilidades   |
| [Memoria](https://nastech-agent.nastechresearch.com/docs/user-guide/features/memory)                   | Memoria persistente, perfiles de usuario, mejores prácticas  |
| [Integración MCP](https://nastech-agent.nastechresearch.com/docs/user-guide/features/mcp)              | Conecta cualquier servidor MCP para capacidades extendidas   |
| [Programación Cron](https://nastech-agent.nastechresearch.com/docs/user-guide/features/cron)           | Tareas programadas con entrega a plataforma                  |
| [Archivos de Contexto](https://nastech-agent.nastechresearch.com/docs/user-guide/features/context-files) | Contexto de proyecto que da forma a cada conversación      |
| [Arquitectura](https://nastech-agent.nastechresearch.com/docs/developer-guide/architecture)            | Estructura del proyecto, bucle del agente, clases principales |
| [Contribuir](https://nastech-agent.nastechresearch.com/docs/developer-guide/contributing)              | Configuración de desarrollo, proceso de PR, estilo de código |
| [Referencia de CLI](https://nastech-agent.nastechresearch.com/docs/reference/cli-commands)             | Todos los comandos y flags                                   |
| [Variables de Entorno](https://nastech-agent.nastechresearch.com/docs/reference/environment-variables) | Referencia completa de variables de entorno                  |
...
```bash
nastech claw migrate              # Migración interactiva (preset completo)
nastech claw migrate --dry-run    # Vista previa de qué se migraría
nastech claw migrate --preset user-data   # Migrar sin secretos
nastech claw migrate --overwrite  # Sobreescribir conflictos existentes
```
...
- **Habilidades** — habilidades creadas por el usuario → `~/.nastech/skills/openclaw-imports/`
...
Consulta `nastech claw migrate --help` para todas las opciones, o usa la habilidad `openclaw-migration` para una migración guiada interactiva por el agente con vistas previas de dry-run.
