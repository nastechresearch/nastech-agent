"""Plugin-owned durable state and namespaced settings helpers (split out of nastech_cli.plugins)."""
...
from nastech_cli.plugins_manifest import _portable_skill_namespace
