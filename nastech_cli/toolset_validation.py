...
_NO_TOOLS = "the agent will have no tools on this platform. Run `nastech tools` to reconfigure."
...
def _platform_default_is_valid(
    ...
    # nastech-<platform> name is not in TOOLSETS.
    try:
...
def validate_platform_toolsets(
    ...
    Reports: a toolset name ``is_valid_toolset`` rejects (suggesting ``nastech-<platform>`` when that
