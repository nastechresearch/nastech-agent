"""Relay subscriber for the persisted Nastech shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Nastech counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Nastech shared metric: %s", metric_name, exc_info=True
                )
