"""Transmit exported shared-metrics packages to the Nastech telemetry service.
...
def _post(endpoint: str, payload: bytes, *, timeout: int) -> _Response:
    ...
    headers = {
        ...
        "User-Agent": "nastech-agent-shared-metrics/1",
    }
    body = payload
...
def reconcile_send_consent(
    ...
    *,
    ...
    harness in tests/nastech_cli/test_shared_metrics_consent_windows.py):
