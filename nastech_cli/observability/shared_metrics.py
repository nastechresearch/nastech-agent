...
class SharedMetricsStore:
        ...
        return [
            {
                ...
                "resource": {
                    "nastech_version": row["nastech_version"],
    ...
    def _add_send_columns(connection: sqlite3.Connection) -> None:
        ...
        branch, so bumping would make an older Nastech — a second profile on an
    ...
    def _create_package_in_transaction(
        ...
        resource = {
            "nastech_version": period_row["nastech_version"],
