"""``nastech computer-use`` subcommand parser."""
...
def _cu_install(args) -> int:
    from nastech_cli.tools_config import _cua_driver_contract_status, install_cua_driver
...
def _cu_status(args) -> int:
    ...
    # install that `nastech computer-use install` will (correctly) refuse to touch,
