"""``nastech backup`` subcommand parser."""
...
def build_backup_parser(subparsers, *, cmd_backup: Callable) -> None:
    ...
    backup_parser = subparsers.add_parser(
        "backup", help="Back up Nastech home directory to a zip file",
    ...
    backup_parser.add_argument(
        "-o",
        "--output", help="Output path for the zip file (default: ~/nastech-backup-<timestamp>.zip)")
    backup_parser.add_argument(
    ...
    backup_parser.add_argument(
        ...
        help="After a full backup, delete older nastech-backup-*.zip files in the output "
