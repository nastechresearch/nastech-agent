...
from nastech_cli.subcommands._shared import add_json_flag
...
def build_plugins_parser(subparsers, *, cmd_plugins: Callable) -> None:
    ...
    plugins_parser = subparsers.add_parser(
        ...
        description="Install, update, remove, list, or validate native Nastech plugins "
    ...
    plugins_install.add_argument(
        "identifier",
        help="Bare plugin catalog entry name (see `nastech plugins search`), Git URL, or owner/repo "
            "shorthand (e.g. anpicasso/nastech-plugin-chrome-profiles)")
    plugins_install.add_argument(
    ...
    plugins_search = plugins_subparsers.add_parser(
        "search", help="Search the curated Nastech plugin catalog")
    ...
    plugins_pack = plugins_subparsers.add_parser(
        "pack", help="Declarative, shareable plugin sets (nastech-pack.yaml)",
    ...
    pack_install.add_argument("source", help="Path to a nastech-pack.yaml file, or an https:// URL")
    ...
    pack_export.add_argument(
        "--name", default="my-nastech-pack", help="Pack name to embed in the exported YAML")

    pack_show = pack_subparsers.add_parser(
        "show", help="Dry-run: parse and display a pack without installing")
    pack_show.add_argument("source", help="Path to a nastech-pack.yaml file, or an https:// URL")
