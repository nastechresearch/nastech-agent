...
def build_plugins_parser(subparsers, *, cmd_plugins: Callable) -> None:
    ...
    plugins_parser = subparsers.add_parser(
        ...
        description=(
            "Install, update, remove, list, or validate native Nastech plugins "
    ...
    plugins_install.add_argument(
        "identifier",
        help=(
            "Git URL, owner/repo shorthand (e.g. anpicasso/nastech-plugin-chrome-profiles), "
            "or a bare plugin name resolved through the community index "
            "(see `nastech plugins search`)"
        ),
    )
    plugins_install.add_argument(
        "--force",
    ...
    plugins_pack = plugins_subparsers.add_parser(
        "pack",
        help="Declarative, shareable plugin sets (nastech-pack.yaml)",
        description=(
    ...
    pack_install.add_argument(
        "source", help="Path to a nastech-pack.yaml file, or an https:// URL"
    )
    pack_install.add_argument(
        "--force",
        "-f",
