...
def build_profile_parser(subparsers, *, cmd_profile: Callable) -> None:
    ...
    profile_parser = subparsers.add_parser(
        "profile", help="Manage profiles — multiple isolated Nastech instances")
    ...
    profile_create.add_argument(
        ...
        help="With --clone/--clone-from: also carry over the `nastech import-agent` sync manifest so "
             "the new profile stays registered against the same Claude Code / Codex trees "
             "(`nastech -p <name> import-agent --sync`). Never syncs config from the source profile.")
    profile_create.add_argument(
    ...
    profile_purge = profile_subparsers.add_parser(
        ...
        description="Re-run the session/routing identity purge that `nastech profile delete` performs "
    ...
    profile_migrate = profile_subparsers.add_parser(
        ...
        description="Re-run the session/routing identity migration that `nastech profile rename` "
    ...
    profile_export.add_argument(
        ...
        help="Output file (default: a managed profile-exports/<name>-<timestamp>.tar.gz "
             "under the default Nastech home)")
    ...
    profile_install = profile_subparsers.add_parser(
        ...
        description="Install a Nastech profile distribution. SOURCE can be a git URL "
