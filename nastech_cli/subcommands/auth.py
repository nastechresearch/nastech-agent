...
def build_auth_parser(subparsers, *, cmd_auth: Callable) -> None:
    ...
    auth_add.add_argument("--portal-url", help="Nastech portal base URL")
    auth_add.add_argument("--inference-url", help="Nastech inference base URL")
    ...
    auth_upgrade = auth_subparsers.add_parser(
        "upgrade", help="Sign in with a Nastech account, keeping your connectors")
