...
def _ensure_utf8():
    ...
    The CLI prints box-drawing characters (┌│├└─) and the 𓄃 glyph in the setup
    ...
    can even start — e.g. `nastech setup` on a fresh Pi.
    ...
    nastech_cli/stdio.py::configure_windows_stdio() runs later from the entry
