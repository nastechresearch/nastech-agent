...
session reaches the edge of its granted window, Nastech grows the window
...
new window and re-prefills the conversation. Nothing about the Nastech
...
def maybe_grow_window(model_id: str, *, base_url: str, session_tokens: int,
    ...
    from nastech_cli.local_runtime.estimator import profile_from_gguf
    from nastech_cli.local_runtime.gguf import read_gguf_header
