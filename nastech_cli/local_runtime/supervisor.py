...
from nastech_cli.local_runtime.binaries import server_binary, runtimes_root
from nastech_cli.local_runtime.processes import spawn_server
...
def state_path() -> Path:
    """Endpoint state for other Nastech processes (provider resolution routes llamacpp-alias
...
class LlamaServerSupervisor:
    """Own one llama-server router process for the life of a Nastech session."""
