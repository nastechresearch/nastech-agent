...
from nastech_cli.local_runtime.gguf import SPLIT_PART_RE, model_id_from_stem
...
def ensure_local_runtime(config: dict, force: bool = False) -> "object | None":
    ...
    # Another Nastech process may already be supervising — reuse via state, but ONLY while its
