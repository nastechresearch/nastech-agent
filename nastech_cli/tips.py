...
TIPS = [
    ...
    "execute_code helpers require explicit imports: from nastech_tools import json_parse, shell_quote, retry.",
    ...
    'nastech auth reset <provider> [target] clears cooldowns and exhaustion flags on a whole credential pool, or on one credential by index, id, or label.',
...
# Task-oriented example prompts for the empty composer. Kept generic — Nastech is
