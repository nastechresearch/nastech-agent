...
Mirrors ``nastech_cli/kanban_specify.py``: lazy aux client import, lenient response parse,
...
def _extract_json_blob(raw: str) -> Optional[dict]:
    from nastech_cli.kanban_specify import _extract_json_blob as _extract
