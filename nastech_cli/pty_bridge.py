...
``nastech_cli.web_server``. POSIX-only: depends on ``fcntl``, ``termios`` and ``ptyprocess`` (native
...
# ui-tui/packages/nastech-ink/src/ink/termio/host.ts — keep the two in sync.
PTY_HOST_ENV = "NASTECH_PTY_HOST"
