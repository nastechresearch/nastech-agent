...
def _resolve_nastech_portal_url() -> str:
    ...
    try:
        ...
        return "https://portal.nastechresearch.com"
...
_DEFAULT_NASTECH_INFERENCE_BASE = "https://inference-api.nastechresearch.com"
...
def get_pricing_for_provider(provider: str, *, force_refresh: bool = False) -> dict[str, dict[str, str]]:
    ...
    if normalized == "nastech":
        ...
        if base_url:
            # Nastech base_url typically looks like https://inference-api.nastechresearch.com/v1
