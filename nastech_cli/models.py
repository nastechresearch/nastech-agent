...
# nastech_constants.VALID_REASONING_EFFORTS ("none" included so an explicit
...
def get_pricing_for_provider(provider: str, *, force_refresh: bool = False) -> dict[str, dict[str, str]]:
    ...
    if normalized == "nastech":
        ...
        if base_url:
            # Nastech base_url typically looks like https://inference-api.nastechresearch.github.io/v1
