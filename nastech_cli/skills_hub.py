...
def _resolve_short_name(name: str, sources, console: Console) -> str:
    ...
    if len(exact) > 1:
        ...
        # skill: `nastech skills install impeccable` should resolve to the
...
def _resolve_source_meta_and_bundle(identifier: str, sources):
    ...
    skill is how ``nastech skills inspect owner/repo/skills/foo`` showed
...
def do_install(identifier: str, category: str = "", force: bool = False,
    ...
    # metadata.nastech.blueprint block, it is a runnable automation. Register it as
...
def do_update(name: Optional[str] = None, console: Optional[Console] = None,
    ...
    already get from ``nastech update`` (ported from
