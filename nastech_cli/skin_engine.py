"""Nastech skin/theme engine — the theme SDK for every surface."""
...
# Branding shared by every Nastech-named built-in (mono/daylight override help_header).
_NASTECH_BRANDING: Dict[str, str] = _branding(
    "Nastech", "𓄃", "Goodbye! 𓄃", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic Nastech — gold and kawaii",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_NASTECH_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _NASTECH_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
...
def _routed_home_key() -> Optional[str]:
    ...
    return None if get_nastech_home_override() is None else nastech_home_key()
...
def get_active_goodbye(fallback: str = "Goodbye! 𓄃") -> str:
