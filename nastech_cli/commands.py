"""Slash command registry for the Nastech CLI and gateway.
...
class CommandDef:
    ...
    # Key in ``nastech_cli.slash_exec.EXECUTORS`` (a string, not a callable: keeps this module
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("login", "Sign in with a Nastech account (keeps your connectors)", "Info",
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'discord_skill_commands_by_category': ('nastech_cli.commands_platforms', 'discord_skill_commands_by_category'),
    'slack_app_manifest': ('nastech_cli.commands_platforms', 'slack_app_manifest'),
    'slack_native_slashes': ('nastech_cli.commands_platforms', 'slack_native_slashes'),
    'slack_subcommand_map': ('nastech_cli.commands_platforms', 'slack_subcommand_map'),
    'telegram_bot_commands': ('nastech_cli.commands_platforms', 'telegram_bot_commands'),
    'telegram_menu_commands': ('nastech_cli.commands_platforms', 'telegram_menu_commands'),
    'telegram_menu_max_commands': ('nastech_cli.commands_platforms', 'telegram_menu_max_commands'),
}
