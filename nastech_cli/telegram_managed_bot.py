"""Telegram Managed Bot onboarding client: creates a user-owned child bot via the Nastech onboarding
...
def auto_setup_telegram_bot_result(
    api_url: str | None = None, manager_bot: str = "NastechSetupBot",
    ...
    print(f"\n  Contacting Nastech Telegram onboarding service: {resolved_api_url}")
    sys.stdout.flush()
