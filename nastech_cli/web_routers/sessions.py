...
the late-binding seam in :mod:`nastech_cli.web_deps` so tests that
...
from nastech_state import is_malformed_db_error, is_transient_sqlite_error
...
async def import_sessions_endpoint(request: Request):
    ...
    restores a whole Nastech backup archive, while this endpoint is scoped to
