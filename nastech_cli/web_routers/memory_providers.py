...
from nastech_cli.web_server_dashboard import _invalidate_plugins_hub_cache
from nastech_cli.web_server_memory import (
...
from nastech_cli.web_models import MemoryProviderConfigUpdate, MemoryProviderSetupRequest
from nastech_cli.web_routers._common import _CONFIG_MUTATION_LOCK, scoped_to_thread
...
_dependency_importable = late("_dependency_importable", "nastech_cli.web_server_memory")
...
def _install_memory_provider_pip_dependencies(dependencies: List[str]) -> List[Dict[str, Any]]:
    ...
    # read-only and installs must go to NASTECH_LAZY_INSTALL_TARGET, which
