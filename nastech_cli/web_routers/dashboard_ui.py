...
from nastech_cli.web_server_dashboard import (
...
async def get_dashboard_themes():
    ...
    from `~/.nastech/dashboard-themes/*.yaml` ship their normalised `definition`."""
    def _run():
        config = load_config()
...
async def get_plugins_catalog(request: Request):
    ...
    def _run():
        from nastech_cli.plugins_cmd import _discover_all_plugins, _get_disabled_set, _get_enabled_set
        from nastech_cli.plugins_cmd_catalog import installed_catalog_state
        from nastech_cli.web_server_dashboard import _plugin_runtime_status
...
async def put_plugin_providers(request: Request, body: _PluginProvidersPutBody):
    ...
    _require_token(request)
    from nastech_cli.plugins_cmd import _save_context_engine, _save_memory_provider
