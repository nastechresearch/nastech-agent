...
to the resolved absolute path of the client binary.  Nastech' interpreter is
...
* Dynamically-linked builds look up ``libpython`` via
  ...
  no dylib — every nastech command, including update/doctor, died in dyld
  (#95425).
...
from nastech_cli.managed_uv import _RUNTIME_DIR_NAME
