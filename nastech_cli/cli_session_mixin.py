...
Mixin bound onto ``NastechCLI`` via the MRO. cli.py-internal symbols are imported LAZILY
...
class CLISessionMixin:
    ...
    def _show_session_status(self):
        ...
        lines = ["Nastech CLI Status", "", *status_lines(fields, "session_id", "path", "title", "model")]
        try:
            from agent.i18n import t
            from nastech_cli.auth import resolve_provider
            from nastech_cli.anon_auth import guest_carries_inference

            if resolve_provider("auto") == "nastech" and guest_carries_inference():
    ...
    def _show_recent_sessions(self, *, reason: str = "history", limit: int = 10) -> bool:
        ...
        from nastech_cli.timefmt import relative_time as _relative_time
    ...
    def save_conversation(self, cmd: str = "/save"):
        ...
        try:
            ...
            # tools/subprocesses on this thread resolve NASTECH_SESSION_ID to the child id after an
    ...
    def _write_terminal_breadcrumb(self) -> None:
        """Record this terminal's live session for bare ``nastech -c``. Called whenever
    ...
    def _toggle_yolo(self):
        ...
        ``NASTECH_YOLO_MODE``: that env var is frozen into ``tools.approval._YOLO_MODE_FROZEN``
    ...
    def _print_exit_summary(self, clear_screen: bool = True):
        ...
        # the hint ("default"/"custom" use the standard NASTECH_HOME).
        try:
