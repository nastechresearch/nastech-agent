...
DEFAULT_SOUL_MD = (
    "You are Nastech Agent, built by Nastech Research. Be direct: match the length of your reply to the weight of "
...
_SCAFFOLD_HEAD = (
    ...
    "The agent will embody whatever you write here.\nEdit this to customize how Nastech communicates with you.\n\n"
)
_SCAFFOLD_TAIL = (
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are Nastech Agent, an intelligent AI assistant created by Nastech Research. You are helpful, "
