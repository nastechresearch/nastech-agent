...
from nastech_cli.dashboard_auth.refresh_singleflight import refresh_session_coalesced
from nastech_cli.dashboard_auth.request_utils import (
...
def _safe_next_target(request: Request) -> str:
    ...
    SPA's ``sessionStorage["nastech.lastLocation"]``."""
...
_PLUGIN_COMPAT_LAZY = {
    'DashboardAuthProvider': ('nastech_cli.dashboard_auth.base', 'DashboardAuthProvider'),
}
