...
``@nastech-research/ui`` design system; fonts load from the SPA's ``/fonts/``
...
<body>
<main>
  <div class="brand">Nastech<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
...
See the <a href="https://nastechresearch.github.io/nastech-agent/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
