...
from nastech_cli.dashboard_auth import prefix as _prefix_mod
...
from nastech_cli.dashboard_auth.cookies import (
    ...
    set_session_cookies)
from nastech_cli.dashboard_auth.login_page import (
...
def _provider_pkce_segments(cookie_payload: dict[str, str]) -> dict[str, str]:
    ...
    flat = cookie_payload.get("nastech_session_pkce", "")
