...
Three cookies in play:
  ...
  - nastech_session_rt:   the OAuth refresh token
                         ...
                         Nastech Portal issues a rotating refresh token for the
...
# auth plugins are enabled (for example Basic + Nastech OAuth).
...
def set_session_cookies(
    ...
    *,
    ...
    ``refresh_token`` is written as the RT cookie when non-empty. Nastech Portal
