...
def check_macos_tcc_anchor_removed() -> None:
    ...
    ``venv/lib/``, which holds no libpython — every nastech command died in
...
def run_doctor(args):
    ...
    # libpython — every nastech command died in dyld). This heals venvs the
    ...
    try:
        from nastech_cli.config import read_user_config_raw as _read_raw_mem
