...
_DEP_CHECKS = {
    # find_node_executable() rather than a bare which(): $NASTECH_HOME/node is
...
def _has_nastech_agent_browser() -> bool:
    ...
    # install.sh installs globally into $NASTECH_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    run_env = nastech_subprocess_env(inherit_credentials=False)
