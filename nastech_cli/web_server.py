...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    "email": {
        ...
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/",
        "env_vars": (
            "EMAIL_ADDRESS",
            "EMAIL_PASSWORD",
            "EMAIL_IMAP_HOST",
    ...
    "google_chat": {
        ...
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/google_chat",
    },
    "wecom": {
    ...
    "weixin": {
        ...
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/weixin/",
    ...
    "teams": {
        ...
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/teams",
    },
    ...
    "irc": {
        ...
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/irc",
    },
    "line": {
        "description": "Use Nastech from LINE via the LINE Messaging API webhook.",
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/line",
    },
    "ntfy": {
        "description": "Chat with Nastech over ntfy push topics (ntfy.sh or self-hosted).",
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/ntfy",
    },
    "photon": {
        "description": "Use Nastech through iMessage via Photon's managed Spectrum platform.",
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/photon",
    },
    "raft": {
        "description": "Join a Raft workspace as an external agent.",
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/raft",
    },
    "simplex": {
        "description": "Talk to Nastech over SimpleX Chat via a local simplex-chat daemon.",
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/simplex",
    },
    "yuanbao": {
        "name": "Yuanbao (元宝)",
    ...
    "webhook": {
        ...
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/webhooks/",
    ...
    "msgraph_webhook": {
        ...
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/msgraph-webhook",
        "required_env": (),
    },
    "whatsapp_cloud": {
        "name": "WhatsApp Cloud API",
        "description": "Use Nastech via Meta's hosted WhatsApp Cloud API (no local bridge).",
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/user-guide/messaging/whatsapp-cloud",
    },
    "relay": {
...
_TELEGRAM_ONBOARDING_DEFAULT_URL = "https://setup.nastech-agent.nastechresearch.com"
...
_OAUTH_PROVIDER_CATALOG: tuple[Dict[str, Any], ...] = (
    {
        ...
        "docs_url": "https://portal.nastechresearch.com",
    ...
    },
    {
        ...
        "docs_url": "https://nastech-agent.nastechresearch.com/docs/guides/xai-grok-oauth",
