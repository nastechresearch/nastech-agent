...
# tests/nastech_cli/test_top_level_value_flags_parity.py fails CI if the parser
...
def top_level_value_flag_sets() -> tuple[frozenset[str], frozenset[str]]:
    ...
    the exact drift that made ``nastech --reasoning high chat …`` misread
...
def build_top_level_parser():
    ...
    # top-level parser: when the user writes `nastech -m foo chat`, argparse
    ...
    # `-w/--worktree`, `--yolo`, etc. (see tests/nastech_cli/
