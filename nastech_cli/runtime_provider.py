...
from nastech_cli.providers import determine_api_mode, is_actual_route, is_official_openai_host, nastech_api_mode
...
def resolve_runtime_provider(*, requested: Optional[str] = None, explicit_api_key: Optional[str] = None,
    ...
    rung returns or raises, else falls to the next):
      ...
      7. OAuth specs (nastech/codex/xai/qwen; "auto" swallows AuthError and logs) → minimax-oauth
