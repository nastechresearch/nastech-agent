#!/usr/bin/env python3
"""Build the Nastech Skills Index — a centralized JSON catalog of all skills.
...
`nastech skills search/install` can use it without hitting the GitHub API.
...
def main():
    print("Building Nastech Skills Index...", flush=True)
