...
function Set-PathVariable {
    ...
    if ($NoVenv) {
        ...
        $nastechBin = "$InstallDir\venv\Scripts"
    }
    
    # Add the venv Scripts dir to user PATH so nastech is globally available
    # On Windows, the nastech.exe in venv\Scripts\ has the venv Python baked in
