...
# tree generates llms.txt — the index every LLM (Nastech included, via the
# nastech-agent skill) reads to learn what Nastech can do — and
...
_PY_RELEVANT_CONTRACT_FILES = {
    ...
    # tests/nastech_cli/test_desktop_slash_registry.py
