#!/usr/bin/env python3
"""Point at something in the Nastech desktop GUI and say one line about it.
...
tool exists — a switch that only made the call fail would leave Nastech
...
def tip_tool(text: str, selector: str, title: str = "", side: str = "") -> str:
    ...
    if not ok:
        return tool_error("tip is only available in the Nastech desktop app.")
