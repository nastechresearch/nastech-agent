...
_HOMEBREW_CI_POLLER_HINT = (
    ...
    'and/or `gh pr checks | jq`. That shape has burned us repeatedly in nastech-agent dev work '
    ...
    "skill_view(name='github/nastech-agent-dev', file_path='references/green-ci-policy.md') for "
...
_ASYNC_UNSUPPORTED_NOTE = (
    ...
    'an async completion after the turn ends (a one-shot runner such as `nastech -z`, a cron '
...
# proc_session attribute -> NASTECH_SESSION_* env var carrying it.
_ROUTING_FIELDS = (
    ("watcher_chat_id", "NASTECH_SESSION_CHAT_ID"),
    ("watcher_user_id", "NASTECH_SESSION_USER_ID"),
    ("watcher_user_name", "NASTECH_SESSION_USER_NAME"),
    ("watcher_thread_id", "NASTECH_SESSION_THREAD_ID"),
    ("watcher_message_id", "NASTECH_SESSION_MESSAGE_ID"),
    ...
    ("parent_session_id", "NASTECH_SESSION_ID"),
)
