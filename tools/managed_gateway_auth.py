...
from tools.managed_tool_gateway import build_vendor_gateway_url, read_nastech_access_token
...
def is_managed_nastech_gateway_url(
    ...
    ``evil-connector-gateway.nastechresearch.github.io.attacker.dev`` and an ``http``
