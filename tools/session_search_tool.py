...
from nastech_state_common import _RESET_END_REASONS
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Nastech conversation history only. It is not evidence "
        ...
        "reformat it as a markdown link or wrap it in backticks. Nastech renders "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about Nastech conversation history itself, such "
