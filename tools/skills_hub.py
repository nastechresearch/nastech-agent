...
_skills_dir = _path_resolver("SKILLS_DIR", "NASTECH_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"NASTECH_HOME": _nastech_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'NASTECH_INDEX_TTL': ('tools.skills_hub_search', 'NASTECH_INDEX_TTL'),
    'NASTECH_INDEX_URL': ('tools.skills_hub_search', 'NASTECH_INDEX_URL'),
    'NastechIndexSource': ('tools.skills_hub_official', 'NastechIndexSource'),
