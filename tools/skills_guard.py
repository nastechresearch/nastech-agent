...
THREAT_PATTERNS = [
    ...
    #     For Nastech/other config files it is high (caution) — legitimate
    ...
    (_prose_modify_re(_NASTECH_CONFIG_FILES),
     "nastech_config_mod", "high", "persistence",
     "modification language aimed at Nastech configuration files (verify intent)"),
    (_shell_write_re(_NASTECH_CONFIG_FILES),
     "nastech_config_mod_shell", "critical", "persistence",
     "shell write (redirect/sed -i/tee/cp/mv) targeting Nastech configuration files"),
    (r'\.nastech/config\.yaml|\.nastech/SOUL\.md',
     "nastech_config_ref", "low", "persistence",
     "references Nastech configuration files (informational; only modification intent is scored)"),
