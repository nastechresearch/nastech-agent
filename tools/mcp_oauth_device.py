...
started by `nastech mcp login/reauth`, never a background reconnect.
"""
...
async def login_device(name, server_url, oauth_config):
    ...
    from tools.mcp_oauth_manager import NastechMCPOAuthProvider, get_manager
    ...
    provider = NastechMCPOAuthProvider(server_url=server_url, server_name=name, storage=storage,
