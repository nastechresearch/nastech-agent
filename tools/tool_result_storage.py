...
is ALWAYS host-side ``$NASTECH_HOME/cache/spillover/{id}.txt`` (works for sessions that never
...
def _write_to_spillover(content: str, filename: str):
    """Write host-side to $NASTECH_HOME/cache/spillover; returns path str or None.
...
def _resolve_storage_dir(env) -> str:
    ...
    return f"{temp_dir.rstrip('/') or '/'}/nastech-results" if temp_dir else STORAGE_DIR
