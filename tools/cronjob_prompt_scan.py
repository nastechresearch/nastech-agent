...
# containing `cat ~/.nastech/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `nastech-agent-dev` skill contains a security postmortem mentioning `cat ~/.nastech/.env`, which tripped
