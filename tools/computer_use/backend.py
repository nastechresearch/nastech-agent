...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of NastechResearch/nastech-agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of NastechResearch/nastech-agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (NastechResearch/nastech-agent#67052). ``ok`` stays
