...
# repeated `nastech mcp test` invocations re-run the preflight for the SAME
...
#
# The cache is also persisted to disk inside the Nastech home so that separate
# `nastech mcp test` processes (and gateway restarts) reuse a warm verdict
