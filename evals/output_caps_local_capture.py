...
Run from a checkout with NASTECH_HOME pointing to a disposable directory.
"""
import json
import os
...
os.environ["NASTECH_MAX_TOKENS"] = "13"
...
from nastech_cli.moa_config import _normalize_preset
