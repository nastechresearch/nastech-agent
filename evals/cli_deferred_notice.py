...
def run_case(root, output, name, behind, early=False, cancel=False):
    with tempfile.TemporaryDirectory(prefix="nastech_test_notice_") as home:
        ...
        from nastech_cli.banner import VERSION
        ...
        bootstrap = ("import nastech_cli.main as m; import nastech_cli.banner as b; "
        ...
        try:
            ...
            result = {"case": name, "ready": ready, "exited": exited,
                      ...
                      "loaded_worktree": str(root / "nastech_cli/banner.py") in text,
