...
Scratch HOME, NASTECH_HOME, Python facade and CLI shims; no user profiles or credentials.
...
(cd apps/desktop && NASTECH_DESKTOP_CDP_PORT=off BOT_DM_SERVICE_PATH=1 \
...
worktree-pinned `nastech`; PATH contains a different inert `nastech` that exits 2
