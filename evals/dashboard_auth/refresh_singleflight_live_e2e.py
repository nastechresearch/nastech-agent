...
os.environ["NASTECH_HOME"] = tempfile.mkdtemp(prefix="nastech-e2e-55712-")
...
idp.calls = 0
ck = "nastech_session_at=expired-at; nastech_session_rt=cookie-stale; nastech_session_provider=stub"
with ThreadPoolExecutor(4) as pool:
