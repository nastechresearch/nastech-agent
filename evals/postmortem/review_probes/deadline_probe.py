...
for k in list(os.environ):
    if k.startswith('NASTECH_') or k.endswith(('_API_KEY', '_TOKEN')):
        os.environ.pop(k, None)
home = tempfile.TemporaryDirectory(prefix='deadline-probe-')
os.environ['NASTECH_HOME'] = home.name
os.environ['NASTECH_DISABLE_TELEMETRY'] = '1'
