...
os.environ.setdefault("NASTECH_HOME", os.path.expanduser("~/.nastech"))  # LIVE: real auxiliary judge calls (cents)
from nastech_cli import goals
goal = ("Simplify the nastech-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
