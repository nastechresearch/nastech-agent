...
Pinned to configured Nastech `google/gemini-3.7-flash`; no provider fallback.
A separate temporary home held only copied Nastech authentication and minimal
