...
os.environ['NASTECH_NIX_BUILD'] = '1'
sys.path.insert(0, str(root))
commands = importlib.import_module("nastech_cli.cli_commands_mixin")
GoalManager = importlib.import_module("nastech_cli.goals").GoalManager
