...
os.environ["NASTECH_HOME"] = str(root / ".nastech")
from nastech_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    for name in ["alpha", "beta"]:
        home = root / ".nastech" / "profiles" / name
    ...
    d = root / ".nastech/logs/update_receipts"
    ...
    home = root / ".nastech/profiles/beta"
