...
def step(mode):
    from nastech_cli.main_dashboard import _install_hangup_protection, _finalize_update_output
    from nastech_cli.main import _run_logged_subprocess
