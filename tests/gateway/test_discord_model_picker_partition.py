...
provider whose list exceeds 25 entries (e.g. Nastech curated + Portal free
...
def test_nastech_free_models_render_across_partitioned_selects():
    ...
    view._selected_provider = "nastech"
    view._build_model_select("nastech")
