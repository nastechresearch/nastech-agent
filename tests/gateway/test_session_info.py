...
class TestFormatSessionInfo:
    ...
    def test_moa_preset_names_the_billed_aggregator(self, runner, tmp_path):
        ...
        moa_cfg = {"moa": {"presets": {"review": {
            ...
            "aggregator": {"provider": "nastech", "model": "claude-opus-4.8"},
        }}}}
        with p1, p2, p3, patch("nastech_cli.config.load_config", return_value=moa_cfg):
            info = runner._format_session_info()
        assert "Acting model (billed for the run): nastech:claude-opus-4.8" in info
