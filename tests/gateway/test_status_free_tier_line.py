"""The in-chat /status line identifies an active Nastech free-tier route."""
...
def _account_state() -> dict:
    return {
        ...
        "access_token": _jwt(client_id="nastech-cli", account_tier="standard"),
...
async def test_status_names_the_free_tier_and_the_slash_command_when_the_free_tier_carries_inference(
    ...
    runner = _runner()
    _seed_nastech(_free_tier_state())
...
def test_the_line_comes_from_the_catalog_in_every_language():
    ...
    for lang in ("ja", "de"):
        ...
        assert line.startswith("Nastech · ") and " · nastech/welcome · " in line and "/login" in line
