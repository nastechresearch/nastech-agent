...
def test_profile_gateway_honors_canonical_root_estop(tmp_path, monkeypatch):
    """fleet-analyst-class: NASTECH_HOME is a profile dir; pause lives at root.

    A process launched with NASTECH_HOME=~/.nastech/profiles/fleet-analyst must
    still treat ~/.nastech/ESTOP as engaged. Otherwise `nastech pause` is not
