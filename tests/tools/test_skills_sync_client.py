...
class TestDevGate:
    def test_gate_open_with_claim(self, monkeypatch):
        ...
        monkeypatch.setattr(auth_nastech, "resolve_nastech_runtime_credentials",
                            lambda **kw: {"api_key": token, "base_url": "https://x"})
    ...
    def test_gate_closed_when_claim_false(self, monkeypatch):
        ...
        monkeypatch.setattr(auth_nastech, "resolve_nastech_runtime_credentials",
                            lambda **kw: {"api_key": token, "base_url": "https://x"})
        assert ssc.resolve_identity()["nastech_admin"] is False
    ...
    def test_maybe_pull_inert_when_not_logged_in(self, monkeypatch):
        ...
        monkeypatch.setattr(auth_nastech, "resolve_nastech_runtime_credentials", _raise)
