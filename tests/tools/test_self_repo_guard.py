...
class TestBlockMessageGuidance:
    ...
    def test_scratch_hint_honors_nastech_home(self, repo, monkeypatch):
        monkeypatch.setenv("NASTECH_HOME", "/custom/nastech-home")
        hit, msg = _detect("git rebase origin/main", repo, repo)
        assert hit is True
        assert "/custom/nastech-home/scratch" in msg
