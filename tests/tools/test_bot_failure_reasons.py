...
FIXTURE_NO_PROVIDER = (
    "agent init failed: No LLM provider configured. Run `nastech model` to select "
    "a provider, or run `nastech setup` for first-time configuration."
)
FIXTURE_NO_TOKEN = "agent init failed: No access token found for Nastech Portal login."
