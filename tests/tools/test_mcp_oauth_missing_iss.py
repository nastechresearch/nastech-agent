...
from tools.mcp_oauth_provider import NastechProviderMixin  # noqa: E402


class _Provider(NastechProviderMixin, OAuthClientProvider):
    pass
...
def _provider_for(issuer: str, *, iss_in_redirect: str | None) -> _Provider:
    ...
    provider._nastech_oauth_flow = "browser"
    return provider
