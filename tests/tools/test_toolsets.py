...
class TestResolveToolsetMemo:
    ...
    def test_second_resolution_is_cached(self, monkeypatch):
        ...
        first = resolve_toolset("nastech-cli")
        second = resolve_toolset("nastech-cli")
        ...
        assert (
            "nastech-cli", True, registry_id, generation, registry.current_scope_key()
    ...
    def test_memo_result_matches_fresh_resolution(self):
        ...
        toolsets_mod._resolve_toolset_memo.clear()
        first = resolve_toolset("nastech-cli", include_registry=False)
        second = resolve_toolset("nastech-cli", include_registry=False)
        assert first == second
