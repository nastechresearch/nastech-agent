...
def test_one_shot_cli_preserves_refusal_reason(monkeypatch, capsys):
    ...
    assert not NastechCLI._claim_active_session(cli, stderr=True)
    assert "nastech-refusal-reason: SESSION_NOT_OWNED\n" in capsys.readouterr().err
