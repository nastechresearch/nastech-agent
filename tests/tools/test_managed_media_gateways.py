...
def test_openai_tts_uses_managed_audio_gateway_when_direct_key_absent(monkeypatch, tmp_path):
    ...
    assert captured["base_url"] == "https://openai-audio-gateway.nastechresearch.github.io/v1"
...
def test_transcription_uses_model_specific_response_formats(monkeypatch, tmp_path):
    ...
    # The managed audio route is the stored "nastech" selection (strict model);
    ...
    transcription_tools._load_stt_config = lambda: {"provider": "nastech"}
    ...
    assert whisper_capture["base_url"] == "https://openai-audio-gateway.nastechresearch.github.io/v1"
