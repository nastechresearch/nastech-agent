...
class TestDelegateTask(unittest.TestCase):
    ...
    def test_nastech_child_rederives_api_mode_from_model(self):
        ...
        Native wire selected (opt-in since 2026-09-06, ``nastech.anthropic_wire``)."""
        with patch("nastech_cli.providers._nastech_anthropic_wire", return_value="native"):
            self._nastech_child_rederives_api_mode_from_model()
