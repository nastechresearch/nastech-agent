...
Real config files in a temp NASTECH_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated NASTECH_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "NASTECH_LOCAL_STT_LANGUAGE",
    ):
