...
hardcoded "~/.nastech/scripts/" in its messages even though resolution goes
through get_nastech_home(), which is per-profile.
"""
...
class TestValidateCronScriptPath:
    ...
    def test_missing_file_error_names_the_resolved_scripts_dir(self):
        ...
        # under profiles, where get_nastech_home() is not the global ~/.nastech.
        scripts_dir = get_nastech_home() / "scripts"
