...
def make_nastech_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated NASTECH_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"nastech-home-{journal_mode}"
