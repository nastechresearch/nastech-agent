"""Regression test: nastech update must not load cryptography eagerly."""
...
assert 'nastech_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running nastech update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so nastech_cli is importable,
