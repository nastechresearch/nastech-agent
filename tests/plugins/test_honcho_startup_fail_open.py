...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "nastech honcho peer --user", "Do not suggest peerName"),
    ("telegram", "Do not suggest peerName", "nastech honcho peer --user"),
])
...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "nastech honcho peer --user", "could not be initialized"),
    ("discord", "supplied no user id", "nastech honcho peer --user"),
])
