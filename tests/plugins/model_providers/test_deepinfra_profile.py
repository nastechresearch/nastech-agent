...
against a gateway-wide enum (``none``..``max``; Nastech-internal ``ultra`` is rejected). The
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"enabled": True, "effort": "ultra"}, {"reasoning_effort": "max"}),  # Nastech-internal tier clamps
