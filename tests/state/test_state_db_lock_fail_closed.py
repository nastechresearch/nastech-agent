...
* `nastech_state._cross_process_repair_lock`   — writable_schema surgery / VACUUM
...
from nastech_state import SessionDB, repair_state_db_schema
...
def test_repair_lock_fails_closed_when_lock_file_is_unopenable(tmp_path):
    ...
    with nastech_state._cross_process_repair_lock(db_path) as holding:
