...
class TestJobsJsonIdKeyedMap:
    ...
    or hand edit — Nastech' own save_jobs() only ever writes a list) made
    ...
    required`` and took down ``nastech cron list``, the ``cronjob(action=
    ...
    def test_list_jobs_survives_id_keyed_map(self, tmp_cron_dir):
        """The reported traceback path (nastech cron list / cronjob list tool)."""
        import json
