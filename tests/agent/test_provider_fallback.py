...
class TestFallbackChainAdvancement:
    ...
    def test_nastech_anthropic_fallback_uses_the_messages_wire(self, monkeypatch):
        ...
        is opt-in since 2026-09-06 (``nastech.anthropic_wire``, see ``nastech_api_mode``).
        """
...
def _write_moa_home(tmp_path, monkeypatch):
    """Real config.yaml with a MoA preset under a temp NASTECH_HOME (genuine preset resolution)."""
    import yaml
