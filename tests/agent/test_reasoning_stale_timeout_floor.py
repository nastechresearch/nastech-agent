...
thinking phase.  Nastech's default cloud-stream stale detector
(``NASTECH_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``NASTECH_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
