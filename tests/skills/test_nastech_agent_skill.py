"""The `nastech-agent` skill is what a running Nastech knows about itself.

`website/` is never packaged, so an installed Nastech has no local copy of the
user guide; skills ARE synced into `$NASTECH_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Nastech can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "nastech-agent"
