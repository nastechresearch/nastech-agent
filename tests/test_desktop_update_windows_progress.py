...
window keeps moving through the long silent stretches (`nastech update`, pip,
...
def test_progress_advances_while_the_orchestrator_blocks(tmp_path: Path) -> None:
    ...
    env["NASTECH_SELFTEST_HOLD_SECONDS"] = "10"
    ...
    try:
        ...
        # boot default instead ('Nastech will open once done.' ==
