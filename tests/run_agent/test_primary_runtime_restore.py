...
5. Recovery is skipped for aggregator providers (OpenRouter, Nastech)
...
def _make_agent(fallback_model=None, provider="custom", base_url="https://my-llm.example.com/v1"):
    ...
    with (
        ...
        # reachable hosts (the nastech portal case) the endpoint's answer for the
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_allowed_for_nastech_anthropic_messages(self):
        ...
        agent._primary_runtime.update({
            ...
            "anthropic_base_url": "https://inference-api.nastechresearch.com/v1",
