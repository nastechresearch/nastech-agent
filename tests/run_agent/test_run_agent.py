...
class TestNastechCredentialRefresh:
    ...
    def test_try_refresh_nastech_client_credentials_rebuilds_client(
        ...
        assert (
            rebuilt["kwargs"]["base_url"] == "https://inference-api.nastechresearch.com/v1"
        )
    ...
    def test_try_refresh_nastech_client_credentials_rebuilds_anthropic_client(
        ...
        agent.base_url = "https://inference-api.nastechresearch.com/v1"
        agent._anthropic_api_key = "stale-nastech-key"
        agent._anthropic_base_url = "https://inference-api.nastechresearch.com/v1"
        ...
        assert agent.base_url == "https://inference-api.nastechresearch.com/v1"
        assert agent._anthropic_api_key == "fresh-portal-jwt"
        assert agent._anthropic_base_url == (
            "https://inference-api.nastechresearch.com/v1"
        )
