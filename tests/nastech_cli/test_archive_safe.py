"""Tests for the shared tar.gz writer (``nastech_cli.archive_safe.make_targz``).

``make_targz`` backs both ``nastech profile export`` and ``nastech kanban
...
from nastech_cli.archive_safe import make_targz
