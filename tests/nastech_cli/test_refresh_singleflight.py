...
from nastech_cli.dashboard_auth import refresh_singleflight as replay
from nastech_cli.dashboard_auth.base import ProviderError, RefreshExpiredError, Session
from nastech_cli.dashboard_auth.routes import router
...
def test_cookie_gate_burst_with_stale_rt_rotates_once(gated_web_app):
    ...
    cookies = {"nastech_session_at": "expired-at", "nastech_session_rt": "stale-rt",
               "nastech_session_provider": "stub"}
