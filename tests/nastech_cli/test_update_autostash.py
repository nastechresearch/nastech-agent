...
def _patch_gateway_discovery():
    ...
    it ``ai.nastech.gateway`` and the verify step exits 1 (#111866, #110701).
    """
    with patch("nastech_cli.gateway.find_gateway_pids", return_value=[]), \
         ...
         patch("nastech_cli.update_cmd_fleet._restart_macos_launchd_gateways", lambda *a, **k: None), \
...
def test_restore_stays_parked_when_untracked_baseline_is_unknown(
    ...
    from nastech_cli import update_cmd
    import nastech_cli.update_cmd_stash as update_cmd_stash
