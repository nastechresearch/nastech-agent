...
def _disable_live_custom_provider_model_probe(monkeypatch):
    ...
    monkeypatch.setattr(
        "nastech_cli.models.fetch_ollama_local_models", lambda *_a, **_kw: None
    )


def test_picker_native_probe_failure_falls_back_to_openai_catalog(monkeypatch):
    monkeypatch.setattr(
        "nastech_cli.models.should_use_ollama_native_catalog", lambda *a, **k: True
    )
    monkeypatch.setattr(
        "nastech_cli.models._get_ollama_native_headers", lambda *a, **k: {}
    )
    monkeypatch.setattr(
        "nastech_cli.models.fetch_ollama_local_models", lambda *a, **k: None
    )
    monkeypatch.setattr(
...
def test_picker_generic_discovery_preserves_api_mode(monkeypatch):
    ...
    monkeypatch.setattr(
        "nastech_cli.models.should_use_ollama_native_catalog", lambda *a, **k: False
    )
...
def test_switch_model_does_not_send_ollama_headers_to_unrelated_custom_endpoint(monkeypatch):
    ...
    monkeypatch.setattr(
        "nastech_cli.models._get_ollama_request_headers",
    ...
    monkeypatch.setattr("nastech_cli.models.validate_requested_model", fake_validation)
    monkeypatch.setattr("nastech_cli.model_switch.get_model_info", lambda *a, **k: None)
    monkeypatch.setattr("nastech_cli.model_switch.get_model_capabilities", lambda *a, **k: None)
...
def test_picker_endpoint_authorization_overrides_inferred_bearer(monkeypatch):
    from nastech_cli.model_switch import _fetch_picker_live_models
    ...
    monkeypatch.setattr("nastech_cli.models.should_use_ollama_native_catalog", lambda *a, **k: True)
    monkeypatch.setattr("nastech_cli.models.fetch_ollama_local_models", fake_native)
