"""Regression: ``nastech doctor --fix`` must not checkpoint the live WAL under a running gateway.
...
# that depend on Nastech *choosing* WAL mode (declined on vulnerable SQLite
