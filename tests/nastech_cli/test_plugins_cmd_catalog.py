"""Catalog-aware ``nastech plugins`` surface (nastech_cli/plugins_cmd_catalog.py): a bare catalog name installs
...
from nastech_cli import plugin_catalog as pc_cat
from nastech_cli import plugins_cmd as pc
from nastech_cli import plugins_cmd_catalog as cat
...
def test_owner_repo_hash_subdir_shorthand_resolves_like_the_catalog_spelling():
    from nastech_cli.plugins_cmd import _resolve_git_url
    assert _resolve_git_url("plastic-labs/honcho#nastech-plugin-honcho") == (
        "https://github.com/plastic-labs/honcho.git", "nastech-plugin-honcho")
