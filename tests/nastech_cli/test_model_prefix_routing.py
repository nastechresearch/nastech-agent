...
``--model nastech/deepseek-v4-pro`` / ``--model ollama/qwen3.5:4b`` used to fall
...
class TestVendorPrefixRouting:
    ...
    def test_configured_provider_prefix_routes_to_provider(self, monkeypatch):
        ...
        monkeypatch.setattr(models, "_configured_provider_ids", lambda: {"nastech"})
        detected = models.detect_provider_for_model("nastech/deepseek-v4-pro", "anthropic")
        assert detected == ("nastech", "deepseek-v4-pro")
