...
Every surface renders through ``nastech_cli.status_report.build_status_fields``; each keeps
...
def test_three_status_surfaces_report_the_same_common_fields():
    with patch("nastech_constants.display_nastech_home", return_value=HOME), \
