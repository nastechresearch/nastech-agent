...
the endpoint spawns the same background ``nastech tools post-setup <key>``
...
class TestToggleToolsetInstallOnEnable:
    ...
    def _spawn_recorder(self, monkeypatch):
        ...
        monkeypatch.setattr(_web_server_gateway, "_spawn_nastech_action", _fake_spawn)
        return calls
    ...
    def test_spawn_failure_does_not_fail_the_toggle(self, monkeypatch):
        ...
        monkeypatch.setattr(_web_server_gateway, "_spawn_nastech_action", _boom)
