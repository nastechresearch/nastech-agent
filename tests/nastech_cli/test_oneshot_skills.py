...
The oneshot path builds its AIAgent directly (bypassing NastechCLI), so the
...
from nastech_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
