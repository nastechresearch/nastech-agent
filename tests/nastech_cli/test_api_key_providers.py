...
class TestResolveApiKeyProviderCredentials:
    ...
    def test_try_gh_cli_token_uses_homebrew_path_when_not_on_path(self, monkeypatch):
        from nastech_cli.copilot_auth import _invalidate_gh_cli_token_cache
...
class TestZaiEndpointAutoDetect:
    ...
    def test_failed_probe_is_not_repeated_within_ttl(self, monkeypatch):
        ...
        from nastech_cli import auth_zai_kimi
        monkeypatch.setenv("GLM_API_KEY", "glm-key-that-429s")
        monkeypatch.setattr(auth_zai_kimi, "_zai_probe_failed_until", {})
        calls = []
        monkeypatch.setattr("nastech_cli.auth.detect_zai_endpoint", lambda *a, **kw: calls.append(1))
        for _ in range(3):
...
class TestHuggingFaceModels:
    ...
    def test_model_lists_match(self):
        ...
        from nastech_cli.models import _PROVIDER_MODELS as main_models
