...
from nastech_cli.doctor import _has_provider_env_config
...
class TestDoctorDeprecatedConfigAndEnv:
    ...
    def test_nastech_tool_progress_warning_says_unsupported_since_floor(self):
        ...
        findings = dict(
            doctor_mod.collect_deprecated_env_vars({"NASTECH_TOOL_PROGRESS": "true"})
        )
        ...
        mode = dict(
            doctor_mod.collect_deprecated_env_vars({"NASTECH_TOOL_PROGRESS_MODE": "all"})
        )
