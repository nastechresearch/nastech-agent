"""Tests for nastech_cli/setup_terminal.py backend wizards."""

import pytest

from nastech_cli.config import save_env_value, get_env_value
from nastech_cli import setup as setup_mod
from nastech_cli import setup_terminal
