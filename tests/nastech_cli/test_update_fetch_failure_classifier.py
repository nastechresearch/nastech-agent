"""Fetch-failure classification for `nastech update` / `nastech update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/NastechResearch/nastech-agent.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `nastech update` sit on
