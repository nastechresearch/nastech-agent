...
def test_resolve_nastech_runtime_credentials_reauths_when_invoke_scope_missing(
    ...
    assert exc.value.code == "nastech_auth_missing_refresh_token"
...
class TestLoginNastechSkipKeepsCurrent:
    ...
    def _patch_login_internals(self, monkeypatch, *, prompt_returns):
        ...
        fake_auth_state = {
            ...
            "inference_base_url": "https://inference-api.nastechresearch.github.io",
            "portal_base_url": "https://portal.nastechresearch.github.io",
...
class TestStalePortalBaseUrlMigration:
    ...
    def test_migrates_stale_portal_url_on_load(self, tmp_path, monkeypatch):
        ...
        auth_file.write_text(json.dumps({
            ...
            "providers": {
                "nastech": {
                    "portal_base_url": "https://api.nastechresearch.github.io",
    ...
    def test_runtime_credentials_rejects_http_for_production_portal(
        ...
        store["providers"]["nastech"]["portal_base_url"] = (
            "http://portal.nastechresearch.github.io"
        )
