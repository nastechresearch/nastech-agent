...
stale-module ImportError after ``nastech update``.
"""
...
import nastech_cli.web_routers.models as _rt_models
...
class TestModelOptionsSkewGuard:
    ...
    def test_fresh_dashboard_builds_payload_unchanged(self, monkeypatch):
        ...
        monkeypatch.setattr("nastech_cli.inventory.load_picker_context", lambda: {})
