...
def test_monitor_shortcuts_preserve_draft_and_respect_modal_prompts(monkeypatch):
    ...
    from nastech_cli import cli_subagent_monitor as monitor
    ...
    monkeypatch.setenv('NASTECH_DEFER_AGENT_STARTUP', '1')
    cli = NastechCLI(model='fixture', provider='openai-compat', api_key='fixture',
