...
import nastech_cli.web_routers.dashboard_ui as _rt_dashboard_ui
...
from nastech_cli import plugin_catalog
...
def _patch_minimal_hub_dependencies(monkeypatch, *, check_fn, discover_all_plugins=None):
    ...
    monkeypatch.setattr(_cfg_mod, "get_nastech_home", lambda: Path("/tmp/nastech-home"))
