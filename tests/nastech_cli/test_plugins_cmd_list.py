...
def test_declared_capabilities_for_entrypoint_uses_distribution_metadata(
    ...
    monkeypatch.setattr(plugins_cmd, "_plugins_dir", lambda: user_dir)
    monkeypatch.setattr(
        "nastech_cli.plugins.get_bundled_plugins_dir", lambda: bundled_dir
    )
    monkeypatch.setattr(
        importlib.metadata,
        "entry_points",
...
def test_unreadable_plugin_dir_is_skipped_by_every_manifest_scan(monkeypatch, tmp_path, caplog):
    ...
    from nastech_cli.plugins_discovery import scan_directory
    ...
    monkeypatch.setattr(plugins_cmd, "_plugins_dir", lambda: user_dir)
    monkeypatch.setattr("nastech_cli.plugins.get_bundled_plugins_dir", lambda: bundled_dir)
