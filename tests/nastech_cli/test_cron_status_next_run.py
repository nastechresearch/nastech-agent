...
from nastech_cli.cron import _print_active_jobs_summary
...
def _frozen_clock(monkeypatch):
    ...
    monkeypatch.setattr(job_store, "_nastech_now", lambda: now)
    monkeypatch.setattr("nastech_time.now", lambda: now)
