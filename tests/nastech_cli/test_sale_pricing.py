...
from nastech_cli.models_pricing import compute_sale_discount, fetch_models_with_pricing
...
def test_free_model_gets_flat_100_percent_discount():
    ...
    # "0.0000000000" strings (Nastech portal shape) count as free too.
...
def test_resolve_nastech_pricing_credentials_honors_inference_env_override(monkeypatch):
    ...
    api_key, base_url = models_pricing._resolve_nastech_pricing_credentials()
    assert api_key == ""
