...
import nastech_cli.macos_tcc_anchor as tcc
...
class TestEnsureTccAnchor:
    ...
    def test_anchors_repair_generation_interpreter(self, tmp_path, monkeypatch):
        """A venv re-created against a .nastech-runtime CVE-repair generation
