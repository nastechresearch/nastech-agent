...
Run before any catalog commit:
    ...
    NASTECH_TEST_NETWORK=1 scripts/run_tests.sh tests/nastech_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("NASTECH_TEST_NETWORK"),
    reason="network test; set NASTECH_TEST_NETWORK=1 to run",
)
