...
def _patch_update_deps(monkeypatch, tmp_path, run_side_effect):
    ...
    monkeypatch.setattr(nastech_main, "_is_fork", lambda *a, **k: False)
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(
        nastech_main, "_finish_dashboard_update_cleanup", lambda *a, **k: None
    )
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(update_cmd, "_purge_stale_nastech_modules", lambda: None)
    monkeypatch.setattr(nastech_main, "_purge_stale_nastech_modules", lambda: None)
