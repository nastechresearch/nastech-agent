...
import nastech_cli.model_switch_providers as nastech_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(nastech_cli_model_switch_providers, "list_authenticated_providers", _capture)
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import nastech_cli.models_catalog_static as nastech_cli_models_catalog_static
    from nastech_cli import models_catalog_static
    ...
    monkeypatch.setattr(nastech_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
