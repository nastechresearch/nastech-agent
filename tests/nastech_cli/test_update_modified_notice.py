...
import nastech_cli.update_cmd_maint as update_maint_mod
import nastech_cli.update_cmd_zip as update_zip_mod
...
def _source_lines() -> list[str]:
    # The update pipeline was extracted to nastech_cli/update_cmd.py and then
