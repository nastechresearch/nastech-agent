...
def policy(monkeypatch):
    ...
    monkeypatch.setattr(models_mod, "nastech_policy_allowed_ids", lambda **_k: ALLOWED)
    return ALLOWED
...
def no_policy(monkeypatch):
    ...
    monkeypatch.setattr(models_mod, "nastech_policy_allowed_ids", lambda **_k: None)
...
class TestRecommendedDefaultEndpoint:
    ...
    def _call(self, monkeypatch):
        import nastech_cli.auth as auth_mod
        from nastech_cli.web_server import get_recommended_default_model
...
class TestAuxiliaryFastModel:
    ...
    def _pick(self, monkeypatch, *, catalog):
        ...
        monkeypatch.setattr(
            models_mod, "_resolve_nastech_pricing_credentials",
    ...
    def test_hidden_model_is_not_selected(self, monkeypatch, policy):
        ...
        monkeypatch.setattr(
            models_mod, "nastech_policy_allowed_ids", lambda **_k: {"vendor/allowed"}
        )
...
def test_titling_seeds_the_shared_catalog_entry_like_the_pickers(monkeypatch):
    ...
    assert seen.get("cache_ttl_seconds") == models_mod._NASTECH_CATALOG_TTL_SECONDS
