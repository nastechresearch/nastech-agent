...
class TestLocalOllamaModelDiscovery:
    ...
    def test_native_tags_cache_expires(self, monkeypatch):
        from nastech_cli.models import fetch_ollama_local_models
    ...
    def test_runtime_error_from_config_load_does_not_escape_ollama_helpers(self):
        ...
        from nastech_cli.models import _get_ollama_base_url, should_use_ollama_native_catalog

        with patch("nastech_cli.config.load_config", side_effect=RuntimeError("bad home")), patch(
            "nastech_cli.models.probe_ollama_local_models",
            return_value=None,
        ):
    ...
    def test_probe_ollama_models_malformed_base_url_returns_none(self):
        ...
        from nastech_cli.models import probe_ollama_local_models
    ...
    def test_fetch_ollama_models_preserves_probe_failure(self):
        ...
        with patch("nastech_cli.models.probe_ollama_local_models", return_value=None):
    ...
    def test_ollama_port_detection_requires_working_api_tags(self):
        ...
        with patch("nastech_cli.models.probe_ollama_local_models", return_value=["qwen3:1.7b"]):
    ...
    def test_provider_model_ids_ollama_cloud_config_uses_generic_catalog(self):
        ...
        ), patch("nastech_cli.models.fetch_ollama_local_models") as fetch_local, patch(
    ...
    def test_native_ollama_catalog_uses_configured_key_env(self, monkeypatch):
        from nastech_cli.models import _get_ollama_request_headers
    ...
    def test_provider_model_ids_ignores_active_non_ollama_custom_endpoint(self):
        ...
        with patch(
            ...
            "nastech_cli.models.fetch_ollama_local_models",
            return_value=["qwen3:1.7b"],
        ) as fetch_local:
            assert provider_model_ids("ollama", force_refresh=True) == ["qwen3:1.7b"]
    ...
    def test_ollama_cache_fingerprint_does_not_probe_custom_endpoint(self):
        ...
        ), patch("nastech_cli.models.probe_ollama_local_models") as probe_ollama:
    ...
    def test_picker_user_provider_verifies_ambiguous_ollama_port(self):
        ...
        with patch("nastech_cli.config.load_config", return_value={"providers": {}}), patch(
            "nastech_cli.models.should_use_ollama_native_catalog",
            return_value=True,
        ), patch(
            "nastech_cli.models.fetch_ollama_local_models",
            return_value=["qwen3:1.7b"],
    ...
    def test_named_custom_model_flow_discovers_ollama_api_tags(self):
        ...
        try:
            ...
            ), patch("nastech_cli.main._save_custom_provider"), patch(
    ...
    def test_model_validation_ollama_cloud_config_does_not_use_local_tags(self):
        ...
        ), patch("nastech_cli.models.probe_ollama_local_models") as probe_ollama, patch(
    ...
    def test_ollama_root_matching_is_case_insensitive_for_hostnames(self):
        from nastech_cli.models import _same_ollama_native_root
