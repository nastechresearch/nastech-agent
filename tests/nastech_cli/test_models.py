...
from nastech_cli import models_local
from nastech_cli import models_validate
...
class TestDetectProviderForModel:
    ...
    def test_short_alias_resolves_to_static_model(self):
        ...
        ), patch("nastech_cli.models_detect.provider_has_credentials", return_value=True):
...
class TestCheckNastechFreeTierCache:
    ...
    def test_cache_only_cold_lookup_does_not_call_portal(self, mock_account):
        assert check_nastech_free_tier(cached_only=True) is False
    ...
    def test_entitlement_cache_is_profile_scoped(self, mock_account, tmp_path):
        ...
        def account_for_active_profile(*, force_fresh=False):
            is_free = nastech_home_key() == nastech_home_key(tmp_path / "free")
        ...
        def check_in(home):
            ...
            try:
                return check_nastech_free_tier()
            finally:
...
class TestFormatPricePerMtok:
    ...
    def test_standard_prices_keep_two_decimals(self):
        from nastech_cli.models_pricing import _format_price_per_mtok
    ...
    def test_nastech_list_includes_sonnet_5(self):
        from nastech_cli.models import _PROVIDER_MODELS
        assert "anthropic/claude-sonnet-5" in _PROVIDER_MODELS["nastech"]
...
class TestLocalOllamaModelDiscovery:
    ...
    def test_native_tags_cache_expires(self, monkeypatch):
        from nastech_cli.models_local import fetch_ollama_local_models
        ...
        try:
            ...
            monkeypatch.setattr("nastech_cli.models.time.monotonic", lambda: 301.0)
    ...
    def test_runtime_error_from_config_load_does_not_escape_ollama_helpers(self):
        ...
        from nastech_cli.models import _get_ollama_base_url
        from nastech_cli.models_local import should_use_ollama_native_catalog

        with patch("nastech_cli.config.load_config", side_effect=RuntimeError("bad home")), patch(
            "nastech_cli.models_local.probe_ollama_local_models",
            return_value=None,
        ):
    ...
    def test_probe_ollama_models_malformed_base_url_returns_none(self):
        ...
        from nastech_cli.models_local import probe_ollama_local_models
    ...
    def test_fetch_ollama_models_preserves_probe_failure(self):
        ...
        with patch("nastech_cli.models_local.probe_ollama_local_models", return_value=None):
    ...
    def test_ollama_port_detection_requires_working_api_tags(self):
        ...
        with patch("nastech_cli.models_local.probe_ollama_local_models", return_value=["qwen3:1.7b"]):
    ...
    def test_provider_model_ids_ollama_cloud_config_uses_generic_catalog(self):
        ...
        ), patch("nastech_cli.models_local.fetch_ollama_local_models") as fetch_local, patch(
    ...
    def test_ollama_cache_fingerprint_does_not_probe_custom_endpoint(self):
        from nastech_cli.models import _credential_fingerprint
        ...
        ), patch("nastech_cli.models_local.probe_ollama_local_models") as probe_ollama:
    ...
    def test_picker_user_provider_verifies_ambiguous_ollama_port(self):
        ...
        with patch("nastech_cli.config.load_config", return_value={"providers": {}}), patch(
            "nastech_cli.models_local.should_use_ollama_native_catalog",
            return_value=True,
        ), patch(
            "nastech_cli.models_local.fetch_ollama_local_models",
            return_value=["qwen3:1.7b"],
        ), patch("nastech_cli.models.fetch_api_models", return_value=[]) as fetch_api:
            rows = list_authenticated_providers(
    ...
    def test_named_custom_model_flow_discovers_ollama_api_tags(self):
        ...
        try:
            with patch("nastech_cli.config.load_config", return_value=config), patch(
                "nastech_cli.config.save_config"
            ), patch("nastech_cli.auth._save_model_choice"), patch(
                "nastech_cli.auth.deactivate_provider"
            ), patch("nastech_cli.main_provider_setup._save_custom_provider"), patch(
                "nastech_cli.curses_ui.curses_radiolist",
    ...
    def test_model_validation_ollama_cloud_config_does_not_use_local_tags(self):
        ...
        ), patch("nastech_cli.models_local.probe_ollama_local_models") as probe_ollama, patch(
    ...
    def test_switch_model_on_current_ollama_custom_endpoint_keeps_base_url(self):
        ...
        try:
            with patch(
                ...
                "nastech_cli.model_switch.get_model_info",
                return_value=None,
            ):
                result = switch_model(
    ...
    def test_ollama_host_environment_forms_are_normalized(self, monkeypatch):
        from nastech_cli.models import _get_ollama_base_url, _root_for_ollama_native_api
...
class TestOpenRouterCatalogDiskCache:
    ...
    def _install_network(monkeypatch, calls):
        ...
        monkeypatch.setattr("nastech_cli.model_catalog.get_curated_openrouter_models",
                            lambda: [("a/one", "")])
