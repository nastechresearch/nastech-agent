...
def test_retirement_reserves_admission_until_cancel_or_permanent_commit(monkeypatch):
    ...
    from nastech_cli import backend_retirement
    ...
    headers = {"X-Nastech-Session-Token": "retirement-test-token"}
...
def test_only_uncommitted_permits_expire_and_unreadable_work_never_grants(monkeypatch):
    from nastech_cli.backend_retirement import RetirementFence
    from nastech_cli import web_server_idle_proof
