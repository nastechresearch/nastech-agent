...
class TestZaiEndpointPicker:
    ...
    def test_custom_proxy_rejects_invalid_url(self, config_home, monkeypatch, capsys):
        ...
        with patch("nastech_cli.main_provider_setup._prompt_provider_choice", return_value=custom_idx), \
    ...
    def test_current_endpoint_is_default_choice(self, config_home, monkeypatch):
        ...
        with patch("nastech_cli.main_provider_setup._prompt_provider_choice", side_effect=fake_choice):
