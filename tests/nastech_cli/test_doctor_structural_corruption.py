...
only when every damaged object is a Nastech FTS shadow.
"""
...
from nastech_cli.doctor_state import _state_db_health
from nastech_state import SessionDB
from nastech_state_repair import integrity_damage_is_structural, state_db_has_structural_damage
...
def test_doctor_routes_structural_damage_to_recover_not_fts_rebuild(tmp_path, monkeypatch):
    ...
    .malformed-backup, nothing fixed) and must point at `nastech sessions recover` for THIS
