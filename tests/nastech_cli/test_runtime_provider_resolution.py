...
def test_codex_pool_honors_nastech_codex_base_url(monkeypatch):
...
def test_explicit_openrouter_config_mirror_bypasses_pool(monkeypatch):
    ...
    # The canonical URL that `nastech setup` persists is NOT a mirror: the pool must still serve it.
