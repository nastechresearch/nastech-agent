...
def test_bom_first_key_is_seen_by_installer_and_scrub_alike(tmp_path, monkeypatch):
    ...
    the key set the installers define (``load_nastech_dotenv`` into os.environ, ``load_env_file`` into a
    ...
    from nastech_cli.env_loader import _env_keys_defined_in_dotenv
