...
Nastech-subscription managed flow, ``_write_provider_config`` first set
...
FAL_KEY instead of the Nastech Tool Gateway (real incident: personal key
...
def test_reconfigure_managed_fal_row_keeps_gateway_flag(monkeypatch):
    ...
    branch wrote True — a Nastech Subscription user re-entering the picker to
