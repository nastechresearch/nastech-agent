...
class _StubCLI:
    def _stage_and_swap_model(self, result, old_model):
        ...
        return _cli_mod.NastechCLI._stage_and_swap_model(self, result, old_model)
    ...
    def _confirm_and_apply_cli_model_switch(
        ...
        return cli_mod.NastechCLI._confirm_and_apply_cli_model_switch(
...
def _patch_deps(monkeypatch, printed):
    ...
    monkeypatch.setattr(
        "nastech_cli.model_switch.switch_model", lambda **_: _make_result()
    )
    monkeypatch.setattr(
        "nastech_cli.model_switch.resolve_display_context_length", lambda *a, **k: None
    )
    return cli_mod
