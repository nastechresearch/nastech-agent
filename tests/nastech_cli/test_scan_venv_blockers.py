...
def test_classify_local_preview_args_preserves_full_directory_label_and_port() -> None:
    args = [
        r"C:\Nastech\venv\Scripts\python.exe",
        "-m",
        "http.server",
        "8766",
        "--bind",
...
_SERVE_CMD = r"C:\x\venv\Scripts\python.exe -m nastech_cli.main serve --host 127.0.0.1"
...
def test_updater_owned_backend_live_foreign_spawner_still_blocks(monkeypatch, capsys):
    ...
    from nastech_cli import _scan_venv_blockers as scan_mod
...
def test_updater_owned_backend_non_backend_argv_never_deferred(monkeypatch, capsys):
    ...
    kanban = (
        78,
        "python.exe",
        r"C:\x\venv\Scripts\python.exe -m nastech_cli.main kanban --preserve-cache",
    )
