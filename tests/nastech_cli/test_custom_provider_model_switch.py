...
class TestCustomProviderModelSwitch:
    ...
    def test_custom_endpoint_switch_prunes_stale_model_config_pool_entry(
        ...
        from nastech_cli.model_setup_flows import _model_flow_custom
        ...
        with patch(
            ...
            return_value={
             ...
             patch("nastech_cli.main_provider_setup._prompt_custom_api_mode_selection", return_value=""), \
             patch(
                 "builtins.input",
                 side_effect=[
...
class TestCustomProviderDiscoverModels:
    ...
    def test_discover_false_with_only_singular_model_skips_probe(self, config_home):
        ...
        with patch("nastech_cli.models.fetch_api_models") as mock_fetch, \
             patch("nastech_cli.models_local.fetch_ollama_local_models") as mock_ollama, \
             patch("nastech_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
