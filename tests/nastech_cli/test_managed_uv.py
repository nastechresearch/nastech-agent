...
class TestWindowsRuntimeSelfLock:
    ...
    A CLI ``nastech update`` runs from the venv's own python, and
    ...
    def test_self_lock_defers_repair_before_provisioning(
        ...
        from nastech_cli import managed_uv
        from nastech_cli.managed_uv import repair_vulnerable_runtime
        ...
        with patch(
                 "nastech_cli.managed_uv._windows_runtime_holders",
                 return_value=(False, ""),
             ), \
             patch(
                 "nastech_cli.managed_uv.probe_sqlite_runtime",
    ...
    def test_venv_launcher_ancestor_is_a_self_lock(self, tmp_path, monkeypatch):
        r"""The venv\Scripts\nastech.exe shim stays mapped while it waits for
