...
class TestManifestParsing:
    ...
    def test_suggest_onboarding_metadata_is_additive(self, catalog_dir):
        from nastech_cli.mcp_catalog import _build_server_config, _parse_manifest
        from nastech_cli.web_routers.mcp import _catalog_entry_json
...
class TestInstall:
    ...
    def test_install_rejects_exfil_shaped_stdio_manifest(self, catalog_dir):
        ...
        from nastech_cli.config import load_config
        from nastech_cli.mcp_catalog import CatalogError, install_entry
    ...
    def test_install_oauth_preregistered_client_writes_oauth_block(self, catalog_dir, monkeypatch):
        ...
        from nastech_cli import mcp_catalog
        from nastech_cli.config import get_config_path, get_env_value, load_config
...
class TestGitInstallShaRef:
    def test_sha_ref_skips_branch_attempt(self, catalog_dir, monkeypatch, tmp_path):
        ...
        from nastech_cli import git_credentials
...
class TestShippedCatalog:
    def test_asana_catalog_targets_v2_with_preregistered_client(self, monkeypatch):
        ...
        from nastech_cli.mcp_catalog import _build_server_config, _catalog_root, _parse_manifest
