...
def _sanitize_ws_text(text: str) -> str:
    ...
    replacement every other Nastech transport applies.
    """
...
class WSTransport:
    ...
    def __init__(
        ...
        *,
        ...
        #: ``nastech_cli.web_server._ws_auth_reason`` onto the WS object and
...
async def handle_ws(
    ...
    *auth_identity* is the server-minted ``{user_id, provider}`` recorded at
    WS-upgrade authentication (``nastech_cli.web_server._ws_auth_reason``); it
