...
def busy_message(command: str) -> str:
    ...
    return (f"session busy — Nastech is still replying. Stop the current reply first (Stop button, "
...
AGENT_STILL_STARTING = (
    "Nastech is still starting this session (loading tools), so this command could not run yet. "
