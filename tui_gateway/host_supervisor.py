...
def _default_registry_path() -> Path:
    return get_nastech_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_nastech_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_nastech_home = expected_nastech_home if expected_nastech_home is not None else str(get_nastech_home())
    ...
    def _validate_hello(self) -> None:
        ...
        if got_home and got_home != self.expected_nastech_home:
            raise RuntimeError(f"compute host NASTECH_HOME mismatch: {got_home} != {self.expected_nastech_home}")
