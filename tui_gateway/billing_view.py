...
Data-building lives in agent/billing_view.py + nastech_cli/nastech_billing.py.
...
def _serialize_billing_state(state, *, free_tier: bool = False) -> dict:
    ...
    Nastech free tier: no account, no balance, nothing to pay; the renderer branches on it before
    ``logged_in``."""
    from agent.billing_view import format_money
    from nastech_cli.anon_auth import GUEST_MODEL
