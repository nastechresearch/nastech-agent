...
_WORKER_UNAVAILABLE = "Group Chat worker is unavailable. Restart the Nastech gateway and try again."
...
def _profile_name() -> str:
    return (os.getenv("NASTECH_PROFILE") or "default").strip() or "default"
