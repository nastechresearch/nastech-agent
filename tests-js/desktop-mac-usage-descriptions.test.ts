 ...
 *
 * Each entry is a key/value pair that lands in the packaged Nastech.app's
 ...
 * "Nastech wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Nastech wants to access Music" when Nastech never touches the Music
