...
| 2 | source-evidence | ok | record commit subjects and changed areas from the fresh source |
| 3 | census | ok | count upstream files before touching anything |
| 4 | plan | ok | next snapshot = Nastech-Update#1 |
| 5 | brand | ok | brand every folder, file name and text file |
| 6 | reconcile | ok | sync lockfile root records + apply fork-local content fixes |
| 7 | preserve | ok | carry fork-local files (owned assets, emails, fork-only skills) into the snapshot |
...
- total files : 9298
- renamed     : 1223 (folders and file names)
- text-rewritten : 8579
- locked-copied  : 679
- binary-copied  : 8
