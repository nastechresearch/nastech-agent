...
two endpoints so a fresh Nastech install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``nastech tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `nastech tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `nastech tools` for reliable service."
            ),
        }
