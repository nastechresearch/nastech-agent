...
from tools.xai_http import (
    build_xai_storage_options, nastech_xai_user_agent, maybe_mark_xai_storage_notice_seen,
...
def _fetch_live_models(creds: Optional[Dict[str, Any]] = None) -> Dict[str, Dict[str, Any]]:
    ...
    response = requests.get(
        ...
        headers={"Authorization": f"Bearer {api_key}", "User-Agent": nastech_xai_user_agent()},
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        storage_options = build_xai_storage_options(
            "image_gen", filename_prefix="nastech-xai-image", extension="png")
