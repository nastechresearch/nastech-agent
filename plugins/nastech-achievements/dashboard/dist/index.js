(function () {
  ...
  function api(path, options) {
    ...
    const url = "/api/plugins/nastech-achievements" + path;
  ...
  async function buildShareImage(achievement) {
    ...
    ctx.fillText("NASTECH AGENT  ·  nastechresearch.github.io/nastech-agent", 70, H - 40);
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function download() {
      ...
      a.href = url;
      a.download = "nastech-achievement-" + (achievement.id || "badge") + ".png";
    ...
    function tweetText() {
      ...
      const tmpl = tx(t, "share.tweet_text", "Just unlocked {tier_part}\"{name}\" in Nastech Agent 𓄃", {
        tier_part: tierPart,
        name: achievement.name,
      });
      return tmpl + "\n\n@NastechResearch · https://nastechresearch.github.io/nastech-agent";
    }
