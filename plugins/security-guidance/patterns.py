...
NastechResearch modifications: pattern data unchanged from upstream; the upstream RuleId
telemetry table (Claude Code PostToolUse metrics) is dropped — Nastech has no consumer.
Nastech-side wiring lives in __init__.py.
"""
