...
Single-user Nastech memory store plugin.
"""
...
class MemoryStore:
    ...
    def _init_db(self) -> None:
        ...
        # gracefully on NFS/SMB/FUSE-mounted NASTECH_HOME (same issue as
        # state.db / kanban.db — see nastech_state._WAL_INCOMPAT_MARKERS).
