...
def interactive_setup() -> None:
    ...
    from nastech_cli.cli_output import prompt, print_header, print_info, print_success
    ...
    print()
    info("📬 Home Channel: where Nastech delivers cron job results and notifications.",
