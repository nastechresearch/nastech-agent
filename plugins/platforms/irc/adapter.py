...
class IRCAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config, **kwargs):
        ...
        try:
            ...
            self.port = 6697
        self.nickname = _get_scoped_secret("IRC_NICKNAME") or extra.get("nickname", "nastech-bot")
    ...
    async def _handle_line(self, raw: str) -> None:
        ...
        if command == "433":
            # Retry with incrementing suffix: nastech_, nastech_1, nastech_2...
...
def check_requirements() -> bool:
    ...
    # nastech setup / requirements check path.
...
def interactive_setup() -> None:
    """Interactive `nastech gateway setup` flow for the IRC platform.
    ...
    channel = prompt(
        "Channel to join (e.g. #nastech — comma-separate for multiple)",
...
async def _standalone_send(
    ...
    *,
    ...
    nickname = _get_scoped_secret("IRC_NICKNAME") or extra.get("nickname", "nastech-bot")
    ...
    nick_base = nickname.rstrip("_0123456789-")[:24] or "nastech-bot"
