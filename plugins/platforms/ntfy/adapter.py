    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "nastech-in"              # subscribe topic (incoming)
          publish_topic: "nastech-out"     # optional — defaults to topic
...
_ECHO_TAG = "nastech-agent"  # tag added to outgoing messages for echo-loop prevention
...
async def _standalone_send(
    ...
    *,
    ...
    ``nastech cron`` running standalone). Without this hook,
