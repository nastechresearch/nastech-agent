"""
Nastech MCP Server — expose messaging conversations as MCP tools.
...
Plus: channels_list (Nastech-specific extra)

Usage:
    nastech mcp serve
    nastech mcp serve --verbose
...
class EventBridge:
    ...
    This is the Nastech equivalent of OpenClaw's WebSocket gateway bridge.
