...
import { capabilityScoped, nastechApi, type ProfileScope } from '@/api/client'
import { type ChatMessage, toChatMessages } from '@/lib/chat-messages'
import type { SessionMessagesResponse } from '@/types/nastech'
...
export async function fetchHistoryWindow(
  ...
  const response = await nastechApi<HistoryWindowResponse>({
    ...route,
