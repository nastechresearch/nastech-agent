import { skillCatalogInstallIdentifier } from '@nastech/shared'
...
const DOCS_ORIGIN = 'https://nastechresearch.github.io/nastech-agent'
...
const CATALOG_BASE = 'https://nastechresearch.github.io/nastech-agent/docs/api'
...
export function parseCatalog(kind: CatalogKind, data: unknown): CatalogEntry[] {
  ...
  for (const row of data) {
    ...
    entries.set(id, {
      ...
      requiresNastech: text(row.requiresNastech),
      tags,
      tools,
      hooks,
