...
import { useNastechConfigRecord } from '../hooks/use-config-record'
...
export function ContribWiring({ children }: { children: ReactNode }) {
  ...
  // Without this pin, the owner ladder sends session.create to nastech-setup
  ...
  }, [gatewayScope, refreshCurrentModel, refreshNastechConfig])
  ...
  const configRecord = useNastechConfigRecord()
