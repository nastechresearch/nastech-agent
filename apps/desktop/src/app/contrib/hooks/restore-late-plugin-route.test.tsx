...
const desktopWindow = window as unknown as { nastechDesktop: unknown }
const originalBridge = desktopWindow.nastechDesktop
...
afterEach(() => {
  ...
  desktopWindow.nastechDesktop = originalBridge
})
