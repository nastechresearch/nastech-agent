...
import type { ConfigFieldSchema, EnvVarInfo, NastechConfigRecord } from '@/types/nastech'
...
const searchCopy = {
  fieldDescriptions: {
    'display.personality': 'Choose how Nastech sounds in conversation.',
...
describe('settings search index', () => {
  it('builds config results from renderable schema fields with exact deep links', () => {
    ...
    expect(entries[0]).toMatchObject({
      context: 'Chat',
      description: 'Choose how Nastech sounds in conversation.',
      label: 'Personality',
