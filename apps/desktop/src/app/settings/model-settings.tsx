...
import { invalidateNastechConfig, setNastechConfigCache, useNastechConfigRecord } from '../hooks/use-config-record'
...
export function ModelSettings({ onMainModelChanged }: ModelSettingsProps) {
  ...
  const { data: config } = useNastechConfigRecord()
