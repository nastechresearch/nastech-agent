...
describe('ProvidersSettings', () => {
  ...
  it('uses the settings target for account reads, removal and sign-in', async () => {
    ...
    try {
      ...
      expect(startManualProviderOAuth).toHaveBeenCalledWith('nastech', 'beta')
      fireEvent.click(await screen.findByRole('button', { name: 'Remove Nastech Portal' }))
      fireEvent.click(await screen.findByRole('button', { name: 'Disconnect' }))
      await waitFor(() => expect(disconnectOAuthProvider).toHaveBeenCalledWith('nastech', 'beta'))
    } finally {
      $settingsScopeOverride.set(null)
    }
  })
  ...
  it('disconnects a connected provider account and refreshes the accounts list', async () => {
    ...
    await waitFor(() => expect(disconnectOAuthProvider).toHaveBeenCalledWith('nastech', undefined))
