...
import { capabilityScoped, getApiRequestConnection, nastechApi, type ProfileScope, profileScoped } from './client'
...
export async function listSessions(
  ...
  const result = await nastechApi<PaginatedSessions>({
    ...profileScoped(),
    path:
...
export async function listSidebarSessions(req: SidebarSessionsRequest): Promise<SidebarSessionsResponse> {
  ...
  try {
    result = await nastechApi<SidebarSessionsResponse>({
      ...profileScoped(),
...
export function searchSessions(query: string): Promise<SessionSearchResponse> {
  return nastechApi<SessionSearchResponse>({
...
export function getSessionMessages(
  ...
  return nastechApi<SessionMessagesResponse>({
    ...sessionScope,
...
export function renameSession(
  ...
  return nastechApi<{ ok: boolean; title: string }>({
    ...(profile ? { profile } : {}),
    path: `/api/sessions/${encodeURIComponent(id)}`,
    method: 'PATCH',
