...
export function getMessagingPlatforms(profile?: null | string): Promise<MessagingPlatformsResponse> {
  return nastechApi<MessagingPlatformsResponse>({
...
export function updateMessagingPlatform(
  ...
  return nastechApi<MessagingPlatformUpdateResponse>({
    ...profileScoped(profile),
...
export function testMessagingPlatform(
  ...
  return nastechApi<MessagingPlatformTestResponse>({
    ...profileScoped(profile),
...
export function startTelegramOnboarding(
  ...
  return nastechApi<TelegramOnboardingStartResponse>({
    ...profileScoped(profile),
...
export function getTelegramOnboardingStatus(
  ...
  return nastechApi<TelegramOnboardingStatusResponse>({
    ...profileScoped(profile),
...
export function applyTelegramOnboarding(
  ...
  return nastechApi<TelegramOnboardingApplyResponse>({
    ...scope,
...
export function getPairing(profile?: null | string): Promise<PairingResponse> {
  return nastechApi<PairingResponse>({
    ...profileScoped(profile),
    path: '/api/pairing'
  })
}
...
export function approvePairing(
  ...
  return nastechApi<{ ok: boolean; user: PairingUser }>({
    ...scope,
...
export function getWebhooks(): Promise<WebhooksResponse> {
  return nastechApi<WebhooksResponse>({
    ...profileScoped(),
    path: '/api/webhooks'
  })
}
...
export function enableWebhooks(): Promise<WebhookEnableResponse> {
  return nastechApi<WebhookEnableResponse>({
    ...profileScoped(),
...
export function createWebhook(body: WebhookCreatePayload): Promise<WebhookCreateResponse> {
  return nastechApi<WebhookCreateResponse>({
    ...profileScoped(),
    path: '/api/webhooks',
    method: 'POST',
    body
...
export function setWebhookEnabled(
  ...
  return nastechApi<{ enabled: boolean; name: string; ok: boolean }>({
    ...profileScoped(),
