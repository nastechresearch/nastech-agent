...
export function createProfile(body: ProfileCreatePayload): Promise<{ name: string; ok: boolean; path: string }> {
  return nastechApi<{ name: string; ok: boolean; path: string }>({
    path: '/api/profiles',
    method: 'POST',
    body
  })
...
export function getProfileSetupCommand(name: string): Promise<ProfileSetupCommand> {
  return nastechApi<ProfileSetupCommand>({
...
export function exportProfileArchive(
  ...
  return nastechApi<{ archive: string; ok: boolean }>({
...
export function importProfileArchive(
  ...
  return nastechApi<{ desktop: null | ProfileDesktopOverlay; name: string; ok: boolean; path: string }>({
