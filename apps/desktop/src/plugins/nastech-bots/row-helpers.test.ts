 ...
 *    the primary profile surfaced as @default instead of @nastech;
 ...
 *    kanban/tool workers count too (nastech-agent#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @nastech, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('nastech')
