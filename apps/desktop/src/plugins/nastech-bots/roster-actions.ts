...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@nastech/plugin-sdk'
 ...
 *  truth before it wins (nastech-agent#90102): a persisted "Bot Chat" tile can
