...
const en: BotsMessages = {
  roster: {
    ...
    rosterUnavailable: reason =>
      `Roster unavailable: ${reason}. If your gateway predates profiles.list, update Nastech and restart the gateway.`,
    waitingForGateway:
  ...
  bot: {
    ...
    attentionMissingConfig: 'Provider not configured — run nastech model',
    ...
    openAnotherChatUnsupported: 'Update Nastech Desktop to open another Bot chat.',
    remoteConnectionsUnsupported: 'Update Nastech Desktop to chat with bots on other connections.',
    openNeedsUpdateTitle: 'This bot lives on an older Nastech',
    openNeedsUpdateMessage: connectionLabel => `Update ${connectionLabel}, then try again.`,
    openUnreachableTitle: 'Nastech couldn’t reach the computer this bot runs on',
...
const ja: BotsMessages = {
  roster: {
    ...
    retryNow: '今すぐ再試行',
    rosterUnavailable: reason =>
      `名簿を取得できません: ${reason}。ゲートウェイが profiles.list より前の場合は、Nastech を更新してゲートウェイを再起動してください。`,
  ...
  bot: {
    ...
    attentionMissingConfig: 'プロバイダーが未設定です — nastech model を実行してください',
    ...
    openAnotherChatUnsupported: '別のボットチャットを開くには Nastech Desktop を更新してください。',
    remoteConnectionsUnsupported: '他の接続上のボットとチャットするには Nastech Desktop を更新してください。',
    openNeedsUpdateTitle: 'このボットは古い Nastech 上で動いています',
    openNeedsUpdateMessage: connectionLabel => `${connectionLabel} を更新してから、もう一度お試しください。`,
    openUnreachableTitle: 'このボットが動いているコンピューターに Nastech が接続できませんでした',
...
const zh: BotsMessages = {
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重试',
    rosterUnavailable: reason => `无法获取名单：${reason}。如果网关早于 profiles.list，请更新 Nastech 并重启网关。`,
  ...
  bot: {
    ...
    attentionMissingConfig: '未配置提供商 — 请运行 nastech model',
    ...
    openAnotherChatUnsupported: '请更新 Nastech Desktop 以打开另一个机器人聊天。',
    remoteConnectionsUnsupported: '请更新 Nastech Desktop 以与其他连接上的机器人聊天。',
    openNeedsUpdateTitle: '这个机器人运行在较旧的 Nastech 上',
    openNeedsUpdateMessage: connectionLabel => `请更新 ${connectionLabel}，然后重试。`,
    openUnreachableTitle: 'Nastech 无法连接到运行这个机器人的电脑',
...
const zhHant: BotsMessages = {
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重試',
    rosterUnavailable: reason => `無法取得名單：${reason}。如果閘道早於 profiles.list，請更新 Nastech 並重新啟動閘道。`,
  ...
  bot: {
    ...
    attentionMissingConfig: '未設定供應商 — 請執行 nastech model',
    ...
    openAnotherChatUnsupported: '請更新 Nastech Desktop 以開啟另一個機器人聊天。',
    remoteConnectionsUnsupported: '請更新 Nastech Desktop 以與其他連線上的機器人聊天。',
    openNeedsUpdateTitle: '這個機器人運行在較舊的 Nastech 上',
    openNeedsUpdateMessage: connectionLabel => `請更新 ${connectionLabel}，然後再試一次。`,
    openUnreachableTitle: 'Nastech 無法連線到運行這個機器人的電腦',
...
export function useBots(): BotsText {
  const t = usePluginI18n('nastech-bots')
