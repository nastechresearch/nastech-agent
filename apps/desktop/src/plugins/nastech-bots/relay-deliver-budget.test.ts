...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/nastech-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'nastech_cli/config_defaults.py'), 'utf8')
