...
import { Button, host, Input, useI18n } from '@nastech/plugin-sdk'
...
export function McpSetupButton({ profile, entry, onDone, ensureProfile }: McpSetupButtonProps) {
  ...
  const beginOAuth = async () => {
    ...
    const mcpOauthBridge =
      typeof window !== 'undefined' && window.nastechDesktop && window.nastechDesktop.mcpOauth
        ? window.nastechDesktop.mcpOauth
        : null
