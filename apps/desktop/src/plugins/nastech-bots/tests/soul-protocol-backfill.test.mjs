...
test('generated protocol uses nastech profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `nastech profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `nastech profiles list` for the LIVE/)
})
