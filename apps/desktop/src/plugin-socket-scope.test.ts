...
// (#73044). Exercises the REAL nastech + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/nastech')
...
const conn = (over: Partial<NastechConnection> = {}): NastechConnection =>
  ({
    authMode: 'oauth',
