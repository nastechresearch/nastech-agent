...
// v1 (`nastech.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'nastech.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'nastech.desktop.statusbarHidden'
// v1 (`nastech.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'nastech.desktop.statusbarVisible.v2'
