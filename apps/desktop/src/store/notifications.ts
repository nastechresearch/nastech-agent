...
export const RECOVERY_ACTIONS = {
  restartNastech: (): NotificationAction => ({
    label: translateNow('notifications.actions.restartNastech'),
 ...
 *  (`nastech_state_errors.classify_persistence_error`). */
...
const ERROR_SUMMARIES: ErrorSummaryRule[] = [
  ...
  },
  {
    ...
    action: () => RECOVERY_ACTIONS.restartNastech()
  },
  {
