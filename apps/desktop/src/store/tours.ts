 ...
 * unlike tips there is no ambient half to separate out — every tour is Nastech
...
export const $toursEnabled = persistentAtom('nastech.desktop.tours.v1', true, Codecs.bool)
