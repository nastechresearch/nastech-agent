...
export interface ComposerAttachment {
  ...
  thumbnailUrl?: string
  path?: string
  /** Bounded source text from a Nastech-generated large paste, sent only to the title path. */
  titlePreview?: string
...
export const SESSION_DRAFTS_STORAGE_KEY = 'nastech:composer-drafts:v3'
 ...
 */
const DRAFT_SYNC_EVENT = 'nastech:composer-draft-sync'
