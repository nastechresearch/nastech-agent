...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('nastech.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('nastech.desktop.unreadFinishedSessions')
