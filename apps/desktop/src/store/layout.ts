...
const SIDEBAR_ALL_PROFILES_AGENTS_GROUPED_STORAGE_KEY = 'nastech.desktop.sidebarAgentsGrouped.allProfiles'
...
const SIDEBAR_CARD_ROWS_STORAGE_KEY = 'nastech.desktop.sidebarCardRows'
const SIDEBAR_SHOW_ALL_SESSIONS_STORAGE_KEY = 'nastech.desktop.sidebarShowAllSessions'
