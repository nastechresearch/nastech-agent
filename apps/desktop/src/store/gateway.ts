import { type ConnectionState, type GatewayEvent, registryBackendScopeKey, resolveGatewayWsUrl } from '@nastech/shared'
...
export function setPrimaryGatewayConnection(connection: Pick<NastechConnection, 'connectionId'> | null): void {
