...
const POPOUT_STORAGE_KEY = 'nastech.desktop.composerPopout.window.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'nastech.desktop.composerPopout.gesturesEnabled'
const ZONES_STORAGE_KEY = 'nastech.desktop.composerPopout.zones.v1'
