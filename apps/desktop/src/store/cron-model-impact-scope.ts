...
function identityForConnection(connection: NastechConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: NastechConnection | null): void {
