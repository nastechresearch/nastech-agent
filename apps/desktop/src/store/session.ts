...
function composerScopeForConnection(connection: NastechConnection | null): string | null {
  if (!connection) {
    return null
  }
...
const SESSION_OWNER_HINTS_KEY = 'nastech.desktop.sessionOwnerHints.v1'
 ...
 * NastechConnection lookup is unavailable. */
...
export const setConnection = (next: Updater<NastechConnection | null>) => {
