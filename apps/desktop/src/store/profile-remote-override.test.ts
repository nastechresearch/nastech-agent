...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://nastech.example.com:8443/x')).toBe('nastech.example.com:8443')
    expect(remoteHostLabel('https://nastech.example.com:443')).toBe('nastech.example.com')
    expect(remoteHostLabel('http://nastech.example.com:80')).toBe('nastech.example.com')
  })
