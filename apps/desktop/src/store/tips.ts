 ...
 * - It covers Nastech too. "Off" from someone who has just closed a bubble means
...
export const $tipsEnabled = persistentAtom('nastech.desktop.tips.rotation.v1', true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('nastech.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('nastech.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'nastech.desktop.tips.next.v1',
  null,
