...
//  - `<nastech home>/desktop-plugins/<name>/plugin.js` — the standalone door
//    (agent- or user-written desktop-only plugins);
//  - `<nastech home>/plugins/<name>/desktop/plugin.js` — the desktop HALF of a
 ...
 *  backend's nastech_home — #66899). `agentPluginsRoot` is optional: older
...
async function diskRoots(): Promise<DiskRoot[]> {
  ...
  if (unified) {
    // Opt-in by default: `~/.nastech/plugins` is installed-but-inert until the
