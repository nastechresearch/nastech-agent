...
export function BootFailureOverlay() {
  ...
  // connection's owning login flow. Nastech Cloud must reuse its portal session
  ...
  let hint: string
  // The electron boot path flags a Nastech Cloud backend-down (502/503/504) with
  ...
  if (remoteReauth) {
    ...
    // A Nastech Cloud agent is down — the user cannot restart the managed
    ...
    actions = [
      ...
      { ...retryAction, variant: 'secondary' },
      {
        ...
        onClick: () => openExternalLink('https://discord.gg/NastechResearch'),
        variant: 'ghost'
      },
