  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground">
        <strong className="font-medium text-foreground">Nothing connects yet.</strong> Nastech will offer to link these
...
function pickAccent(value: string, receipt?: string): void {
  ...
  const accent = hex === NASTECH_ACCENT ? null : hex
...
export function LookCard({ attrs, locked, messageId }: CardProps) {
  ...
  const accent = answers.accent ?? NASTECH_ACCENT
