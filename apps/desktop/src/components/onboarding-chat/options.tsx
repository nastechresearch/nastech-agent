...
// Connectors are the apps Nastech reads and acts on for the user. Chat channels
// (Discord, Telegram, WhatsApp) are how a user talks to Nastech; those live on
...
// the active skin as soon as the swatch is clicked. Nastech blue is the default
// and sets no override. Mono is black in light mode and white in dark mode.
export const NASTECH_ACCENT = '#0053fd'
...
export const accentsFor = (dark: boolean): Array<{ hex: string; name: string }> => [
  ...
  { hex: NASTECH_ACCENT, name: 'Nastech blue' },
