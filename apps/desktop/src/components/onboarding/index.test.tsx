...
describe('onboarding Picker', () => {
  it('features Nastech Portal and hides other providers behind a disclosure', () => {
    setProviders([makeOAuthProvider('anthropic', 'Anthropic Claude'), makeOAuthProvider('nastech', 'Nastech Portal')])
    ...
    // Nastech Portal is visible before the user expands the list.
  ...
  it('shows Fireworks first in the expanded list, ahead of other OAuth providers', () => {
    setProviders([
      ...
      makeOAuthProvider('nastech', 'Nastech Portal')
    ])
    render(<Picker ctx={ctx} />)
    fireEvent.click(screen.getByRole('button', { name: 'Other providers' }))
    ...
    const labels = screen
      ...
      .filter(text => /Nastech Portal|Fireworks AI|ChatGPT or Codex|MiniMax|OpenRouter/.test(text))
  ...
  it('offers "choose later" on first run and persists the skip', () => {
    setProviders([makeOAuthProvider('nastech', 'Nastech Portal')])
    render(<Picker ctx={ctx} />)
