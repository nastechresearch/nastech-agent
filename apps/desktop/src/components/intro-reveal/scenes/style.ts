...
// Nastech blue: the app's --theme-primary (#0053fd), lightened for a dark background.
export const BLUE = '#4d8dff'
export const BLUE_DIM = 'rgba(77, 141, 255, 0.55)'
export const BLUE_FAINT = 'rgba(77, 141, 255, 0.4)'

// One shadow for every floating surface. It follows --shadow-nastech (single top
