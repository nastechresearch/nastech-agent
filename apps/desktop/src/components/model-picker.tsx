...
import type { LocalModelLoadProgress } from '@/types/nastech'
...
export function ModelPickerDialog({
  ...
  // it: an empty query shows the curated list verbatim (like the `nastech
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // Two different facts wear the same badge: `free_tier` is a signed-in Nastech
