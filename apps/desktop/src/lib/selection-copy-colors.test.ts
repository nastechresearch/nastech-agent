...
describe('installSelectionCopyColorGuard', () => {
  beforeEach(() => {
    document.documentElement.dataset.nastechMode = 'dark'
  })

  afterEach(() => {
    delete document.documentElement.dataset.nastechMode
    window.getSelection()?.removeAllRanges()
  })
  ...
  it('leaves light-ink selections alone when the theme is light', () => {
    document.documentElement.dataset.nastechMode = 'light'
