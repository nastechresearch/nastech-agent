import { pluginCatalogInstallUrl, skillCatalogInstallIdentifier, skillCatalogInstallUrl } from '@nastech/shared'
...
describe('public catalog install links', () => {
  it.each([
    ...
    [{ name: 'pdf', source: 'built-in', installIdentifier: 'NastechResearch/nastech-agent/skills/productivity/pdf' }, 'NastechResearch/nastech-agent/skills/productivity/pdf'],
