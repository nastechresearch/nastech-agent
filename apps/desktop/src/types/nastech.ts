...
export interface ModelOptionProvider {
   ...
   *  the `nastech model` CLI / onboarding OAuth flow. */
  auth_type?: string
  ...
  /** Nastech only: whether the current account is on the free tier. */
  free_tier?: boolean
  /** Nastech only: paid models a free-tier user cannot select (shown disabled). */
