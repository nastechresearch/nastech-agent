 ...
 *
 * The palette-bearing skins (nastech, catppuccin, everforest, solarized) are forks
 ...
 *
 *   nastech       ← github.github-vscode-theme   (Light Default / Dark Default)
 ...
 * re-derived. `nastech-alt` is first-party — do not re-derive it from GitHub.
 */
...
/**
 * Nastech — the canonical Nastech desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Nastech's own: a VS Code theme carries no font opinion, and
 * these are the stacks every skin has been rendering with.
 */
/**
 * GitHub — the upstream palette, unmodified.
 *
 * `nastech` is a fork of this with its own accent, so shipping both keeps the
 * original available on its own terms instead of only existing as the thing
 * nastech diverged from. Everything but the accent family is identical between
 * them; separate presets are what let nastech's accent move without silently
...
/**
 * Nastech — the canonical Nastech desktop identity: GitHub's chrome carrying Nastech
...
export const nastechTheme: DesktopTheme = {
  name: 'nastech',
  label: 'Nastech',
  description: 'GitHub chrome, Nastech blue accent',
  colors: {
    background: '#ffffff',
    foreground: '#1f2328',
    card: '#f6f8fa',
...
const NASTECH_ALT_BLUE = '#0053FD'
const NASTECH_ALT_NAVY = '#1540B1'
const NASTECH_ALT_CREAM = '#FFE6CB'

const nastechAltTint = (pct: number) => `color-mix(in srgb, ${NASTECH_ALT_BLUE} ${pct}%, #FFFFFF)`
const nastechAltTintTransparent = (pct: number) => `color-mix(in srgb, ${NASTECH_ALT_BLUE} ${pct}%, transparent)`

/**
 * Nastech Alt — the hand-authored Nastech from before the GitHub fork. Light is
 * glass neutrals with brand blue; dark is cream on mission-blue.
 */
export const nastechAltTheme: DesktopTheme = {
  name: 'nastech-alt',
  label: 'Nastech Alt',
  ...
  colors: {
    ...
    muted: nastechAltTint(5),
    mutedForeground: '#666678',
    popover: '#FFFFFF',
    popoverForeground: '#17171A',
    primary: NASTECH_ALT_BLUE,
    primaryForeground: '#FCFCFC',
    secondary: nastechAltTint(7),
    secondaryForeground: '#242432',
    accent: nastechAltTint(10),
    accentForeground: '#202030',
    border: nastechAltTintTransparent(22),
    input: nastechAltTintTransparent(30),
    ring: NASTECH_ALT_BLUE,
    midground: NASTECH_ALT_BLUE,
    composerRing: NASTECH_ALT_BLUE,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F3F7FF',
    sidebarBorder: nastechAltTintTransparent(18),
    userBubble: nastechAltTint(6),
    userBubbleBorder: nastechAltTintTransparent(24)
  },
  darkColors: {
    background: '#0D2F86',
    foreground: NASTECH_ALT_CREAM,
    card: '#12378F',
    cardForeground: NASTECH_ALT_CREAM,
    muted: '#183F9A',
    mutedForeground: '#B5C7F3',
    popover: '#123A96',
    popoverForeground: NASTECH_ALT_CREAM,
    primary: NASTECH_ALT_CREAM,
    primaryForeground: '#0D2F86',
    secondary: '#1B45A4',
    secondaryForeground: '#E0E8FF',
    accent: NASTECH_ALT_NAVY,
    accentForeground: '#F0F4FF',
    border: '#3158AD',
    input: '#0B2566',
    ring: NASTECH_ALT_CREAM,
    midground: NASTECH_ALT_BLUE,
    composerRing: NASTECH_ALT_CREAM,
    destructive: '#C0473A',
