 ...
 * surfaces mixed from it. In `nastech` that's 7 slots per mode —
 ...
 * literally — Nastech blue `#0053FD` is 5.4:1 on GitHub's light sidebar but only
 ...
 * this accent get in dark mode" — nastech's blues are OKLCH L 0.528 → 0.638 at the
