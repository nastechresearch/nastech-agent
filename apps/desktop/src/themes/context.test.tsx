...
describe('ThemeProvider ← backend skin sync', () => {
  ...
  it('paints a persisted backend skin once the connect-time seed makes it resolvable', () => {
    window.localStorage.setItem('nastech-desktop-theme-v2', 'bloomberg')
...
// here as a reference implementation; the shared @nastech/shared/color ladder
