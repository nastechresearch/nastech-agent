...
export const ja = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      tipsTitle: 'アプリ内ヒント',
      tipsDesc:
        'アプリの一部を指す小さな吹き出し。待機中にときどき、また役に立つときは Nastech からも表示します。閉じたヒントは二度と表示されません。',
      tipsReset: (count: number) => `閉じた${count}件のヒントを元に戻す`,
      toursTitle: 'ガイドツアー',
      toursDesc: '画面を暗くして各ステップを強調しながら、Nastech がアプリを案内します。',
    ...
    localModels: {
      ...
      upToDateDetail: (tag, backend) => `llama.cpp ${tag}（${backend}）で動作中——Nastech が提供する最新ビルドです。`,
      updateToast: next =>
  ...
  prompts: {
    ...
    sudoTitle: '管理者パスワード',
    sudoDesc:
      'Nastech は特権コマンドを実行するために sudo パスワードが必要です。ローカルエージェントにのみ送信されます。',
