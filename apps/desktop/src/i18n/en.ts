...
export const en: Translations = {
  catalog: {
    ...
    snapshotHint: 'From the Nastech catalog. Browsing never contacts source repositories.',
  ...
  sessionImport: {
    ...
    subtitle: 'Bring a conversation into Nastech and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Nastech.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Nastech. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Nastech',
    continue: 'Continue in Nastech',
  ...
  notifications: {
    ...
    voice: {
      ...
      liveDelegationFailed: 'Could not hand the request to Nastech',
  ...
  settings: {
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Nastech catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Nastech generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Nastech picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Nastech.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Nastech closes.',
        statusLocked: 'Locked',
    ...
    appearance: {
      ...
      tipsDesc:
        'Occasional hints from the app and Nastech. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
    ...
    screenshot: {
      ...
      enabledDesc:
        'Press both Command keys together from any app to capture its frontmost window and attach it to your current Nastech draft. Never sends automatically. Off by default; applies only to this Mac. Window contents may be sensitive — review the attachment before sending.',
      ...
      inputPermission:
        'Input Monitoring permission lets Nastech detect both Command keys while another app is active. Allow Nastech in System Settings → Privacy & Security → Input Monitoring, then return here and retry.',
      screenPermission:
        'Screen Recording permission lets Nastech capture the frontmost app window when you use this shortcut. Allow Nastech in System Settings → Privacy & Security → Screen Recording, then return here and retry. Restart Nastech if macOS asks.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Nastech gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Nastech Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Nastech Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Nastech runtime managed by this app.',
      kindRemoteDesc: 'A Nastech gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Nastech Cloud account.',
      kindSshDesc: 'A Nastech install reached over SSH.',
      labelTitle: 'Name',
      ...
      cloudAddHint:
        'Tip: signing in under Nastech Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Nastech backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'This connection was fixed by the way Nastech was launched.',
      envOverrideDesc:
        'A startup setting outside the app chose this connection, so the options below are read-only. Restart Nastech without that setting — or ask whoever set it up — to change it here.',
      ...
      sshErrNotInstalled:
        'Nastech is not installed on the remote host. Install it there (curl -fsSL https://nastechresearch.github.io/nastech-agent/install.sh | sh) or set the Nastech path.',
      sshErrPlatform:
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Nastech. Review the exact configuration below — it comes from the link, not from Nastech.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Nastech starts and manages the server for you.`,
    ...
    toolsets: {
      ...
      nastechAuthFailed: 'Nastech sign-in did not complete',
      nastechAuthFailedMessage: 'Try again.',
      nastechAuthTryAgain: 'Try again',
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `Nastech can't run shell commands right now: ${backend} isn't ready. Switch to Local, or finish setting up ${backend} and try again.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Nastech browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    plugins: {
      ...
      defaultProfile: 'Nastech (default)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      catalogProvenance: (sha: string) => `Installed from the Nastech catalog${sha ? ` at pin ${sha}` : ''}.`,
  ...
  messaging: {
    ...
    restartFailedManual: "Nastech couldn't restart to apply your messaging settings",
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this Nastech installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. Nastech creates the bot and detects your Telegram user ID automatically.',
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Nastech you point it at, instead of this computer.',
    ...
    defaultDescription: 'Used when Nastech opens and for new chats. Existing sessions stay in their profiles.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      worktreeStaleBackend:
        'Update the Nastech backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    voiceEngineChained: 'Speech-to-text + Nastech voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to Nastech)',
  ...
  updates: {
    ...
    connectionRetry:
      "Nastech couldn't reach the update server. Check your internet connection and try again. If you use a remote Nastech, make sure it is online.",
    gitUnusable: 'Nastech could not run Git on this computer, so it could not check for updates.',
    connectionSettings: 'Connection settings',
    ...
    blockerBody:
      'Nastech needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Nastech',
    foreignBlockerBody:
      'Nastech can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Nastech can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  handoffTour: {
    ...
    stayTitle: 'Nastech is one click away',
    stayText: 'Switch to the setup profile and open Welcome to Nastech whenever you want a hand. It stays there.'
  },
  guidedGreeting: {
    line: "Hey, come on in. I'm Nastech. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    failedDesc:
      'One of the setup steps did not finish. This can happen when another copy of Nastech is running, the internet connection dropped, or antivirus blocked the installer. Close other Nastech windows, then choose Reload and retry. If it fails again, open the logs and send them to support.',
    activeDesc:
  ...
  freeTier: {
    providerRowTitle: 'Nastech · free tier',
    providerRowPitch: 'Sign in with a Nastech account to unlock more models and tools.',
    readyTitle: 'Nastech is ready.',
    readyCaption: 'Free · connectors included',
    begin: 'Begin',
    signInInstead: 'Sign in with a Nastech account instead',
    otherProviders: 'Other providers',
    stripTitle: 'Free Nastech inference and connectors are now available.',
    stripBody: 'Open the model picker to try them, or sign in with a Nastech account.',
    openModelPicker: 'Open model picker',
    dismiss: 'Dismiss',
    providerName: 'Nastech',
    statusLabel: model => `Nastech · ${model}`,
    signIn: 'Sign in',
    signInHeading: 'Sign in with a Nastech account to unlock more models and tools.',
    ...
    rejectedBody: "No problem, you're still on the free Nastech service. Sign in whenever you're ready.",
    ...
    busyBody: wait =>
      `Nastech couldn't finish signing you in because the Nastech service is busy. Try again in ${wait}. Your session is still here in the meantime.`,
    unreachableBody:
      "Nastech couldn't reach the Nastech service to finish signing you in. Check your internet connection and try again. Your session is still here.",
    alreadySignedInHeading: 'Already signed in.',
    alreadySignedInBody: 'This Nastech is already signed in to a Nastech account.',
    setupFailed: {
      gateClosed:
        "This version of Nastech can't start without a Nastech account. Sign in or create one, it's free and only takes a minute.",
      paused:
        'Using Nastech without signing in is paused for a moment. Nastech will keep checking. Signing in is free and gets you going right now.',
      rateLimited: wait =>
        `Lots of people are getting started right now, so Nastech will try again in ${wait}. Signing in is free and skips the wait.`,
      unreachable:
        "Nastech couldn't reach the Nastech service. Check your internet connection, then tap Try again. Or connect another provider for now.",
      serverError: 'The Nastech service had a hiccup. Tap Try again in a moment, or connect another provider for now.',
      powRequired:
  ...
  preview: {
    ...
    web: {
      ...
      blankPageBody: 'Type an address above to browse, or ask Nastech to open a page.',
  ...
  assistant: {
    thread: {
      ...
      errorLayers: {
        ...
        gateway: 'Nastech hit a problem',
        generic: "Nastech couldn't finish this reply",
        provider: 'The AI service returned an error',
        runtime: 'Nastech hit a problem',
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `Nastech could not verify the secure connection to ${provider}. Check your network or proxy settings, or switch provider, then send your message again.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} returned something Nastech could not read. Retry in a moment.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Nastech got stuck in a loop',
          body: 'The reply kept repeating the same steps, so Nastech stopped it. Retry, or start a new chat if it happens again.'
        },
        SESSION_NOT_OWNED: {
          title: 'This chat is open somewhere else',
          body: 'This chat is currently open in another Nastech window or terminal. Close it there and send your message again, or start a new chat here.'
        },
        disk_full: {
          title: 'Disk full',
          body: 'Your disk is full, so Nastech could not save this conversation. Free some space, then retry.'
        },
        // Nastech free tier. The body is normally the backend's own sentence (it names the wait
        // and the way forward); these bodies stand in for an older backend that sent none.
        free_tier_disabled: {
          title: 'Using Nastech without signing in is switched off right now',
          body: "Sign in with a Nastech account to keep chatting, it's free."
        },
        free_tier_rate_limited: {
          title: "You've used up the allowance for chatting without signing in",
          body: "It refreshes shortly. Sign in with a Nastech account for a bigger allowance, it's free."
        },
        ...
        free_tier_model_not_free: {
          ...
          body: "Nastech uses the free model for now. Sign in with a Nastech account for more models, it's free."
        },
        free_tier_route: {
          title: "Nastech couldn't reach the free model on this route",
          body: "Sign in with a Nastech account, it's free, or check the NASTECH_INFERENCE_BASE_URL setting."
        },
        free_tier_outage: {
        ...
        free_tier_refused: {
          title: "Nastech couldn't send that without signing in",
          body: 'Signing in with a Nastech account is free.'
        }
      },
      errorAuthKinds: {
        api_key: {
      ...
      errorOpenNastechFolder: 'Open Nastech folder',
      errorOpenNastechFolderFailed: 'Could not open the Nastech folder',
      errorUpdateApiKey: 'Update API key',
      errorSignInAgain: provider => `Sign in to ${provider} again`,
      errorSignInFreeTier: 'Sign in with a Nastech account',
    ...
    approval: {
      gatewayDisconnected:
        'Nastech is offline right now. The command is still waiting for your answer (until the approval timeout). Reconnect, then send it again.',
      sendFailed: 'Could not send your answer',
      reconnect: 'Reconnect',
      timedOutSystemLine:
        'Approval timed out — the command was not run. Ask Nastech to try again, or raise the limit in Settings → Safety → Approval timeout.',
    ...
    clarify: {
      ...
      gatewayDisconnected: 'Nastech is offline right now. Reconnect, then send it again.',
  ...
  prompts: {
    ...
    vaultSaveDesc: origin =>
      `Nastech reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Nastech types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Nastech enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Nastech loads when the work calls for them.'
      },
      messaging: {
        title: 'Nastech away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Nastech made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Nastech — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
