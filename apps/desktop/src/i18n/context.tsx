...
const defaultConfigClient: I18nConfigClient = {
  getConfig: () => {
    ...
    return getNastechConfigRecord(undefined, { includeDefaults: false })
  },
  saveConfig: config => {
    if (typeof window === 'undefined' || !window.nastechDesktop?.api) {
    ...
    return saveNastechConfig(config, undefined, { preserveLanguage: true })
  }
}
    ...
    const loadLocale = () => {
      ...
      return configClient
        ...
        .then(async config => {
          ...
          const machineProfile = await window.nastechDesktop?.getMachineProfile?.().catch(() => null)
