...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      tipsTitle: '應用程式內提示',
      tipsDesc: '指向應用程式某處的小氣泡：閒置時偶爾出現，需要時 Nastech 也會給你一則。關掉一則就不再出現。',
      tipsReset: (count: number) => `復原 ${count} 則已關閉的提示`,
      toursTitle: '導覽',
      toursDesc: '讓 Nastech 帶你認識應用程式：調暗畫面並逐步標示每個位置。',
    ...
    localModels: {
      ...
      upToDateDetail: (tag, backend) => `正在執行 llama.cpp ${tag}（${backend}）——Nastech 提供的最新組建。`,
