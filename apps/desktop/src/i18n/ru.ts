...
export const ru = defineLocale({
  ...
  settings: {
    ...
    plugins: {
      ...
      agent: {
        ...
        blurb:
          'Плагины, установленные в бэкенд Nastech — инструменты, навыки, MCP-серверы, хуки и slash-команды. Переносимые — пакеты Agent Plugins (навыки + MCP-бандлы, работающие и в других агентах). Переключатели действуют для новых сеансов.',
        ...
        updateBackendToManage: 'Обновите бэкенд Nastech, чтобы управлять этим плагином из приложения.',
        sources: {
          bundled: 'встроенный',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Устанавливается в локальный бэкенд ${profile} (~/.nastech/plugins/)`,
  ...
  assistant: {
    ...
    mcpSetup: {
      ...
      catalogSource: 'Из каталога, одобренного Nastech',
  ...
  prompts: {
    ...
    sudoDesc:
      'Nastech нужен ваш пароль sudo, чтобы выполнить команду с повышенными правами. Он отправляется только вашему локальному агенту.',
