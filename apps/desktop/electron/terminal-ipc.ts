...
// registry, and the nastech:terminal:* IPC surface. Extracted from main.ts; the
...
export function registerTerminalIpc({
  ...
  function terminalShellCommand() {
    ...
    const override = (process.env.NASTECH_DESKTOP_SHELL || (isWindows ? '' : process.env.SHELL) || '').trim()
  ...
  ipcMain.handle('nastech:terminal:attach', (event, id) => {
