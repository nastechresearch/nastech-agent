 ...
 *     it via `nastech:profile:remember` without re-homing the primary.
 ...
 * the same NASTECH_HOME. That duplicate held a pool slot and starved every other
...
export class PrimaryProfilePin {
  ...
  /** Called by startNastech() with the profile the primary is launching as. */
