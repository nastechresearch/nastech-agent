...
const POOL_MAX_BACKENDS = Math.max(1, Number(process.env.NASTECH_DESKTOP_POOL_MAX) || 3)
const POOL_IDLE_MS = Math.max(60_000, Number(process.env.NASTECH_DESKTOP_POOL_IDLE_MS) || 10 * 60_000)
