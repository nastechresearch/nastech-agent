...
describe('resolveOutsideAsar', () => {
  ...
  it('redirects a packaged specifier into app.asar.unpacked', () => {
    expect(
      resolveOutsideAsar('file:///Applications/Nastech.app/Contents/Resources/app.asar/dist/node_modules/get-windows/index.js')
    ).toBe('file:///Applications/Nastech.app/Contents/Resources/app.asar.unpacked/dist/node_modules/get-windows/index.js')
  })
  ...
  it('redirects a Windows packaged path built with backslashes', () => {
    expect(resolveOutsideAsar('C:\\Users\\me\\AppData\\Local\\Nastech\\resources\\app.asar\\dist\\node_modules\\get-windows\\index.js')).toBe(
      'C:\\Users\\me\\AppData\\Local\\Nastech\\resources\\app.asar.unpacked\\dist\\node_modules\\get-windows\\index.js'
    )
  })
  ...
  it('requires app.asar to be a complete path segment', () => {
    for (const untouched of [
      ...
      'file:///Users/dev/nastech-agent/node_modules/get-windows/index.js'
    ]) {
