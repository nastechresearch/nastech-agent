...
// be rejected: spawning a fresh backend would call ensure_nastech_home() and
...
/** Parse a `nastech:api` request into the profile name a DELETE targets. */
 ...
 * still removing the profile and recreate its NASTECH_HOME.
 *
