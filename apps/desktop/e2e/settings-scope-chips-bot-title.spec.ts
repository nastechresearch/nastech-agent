...
function seedProfile(nastechHome: string, mockUrl: string, name: string, profileYaml: string): void {
...
test.beforeAll(async () => {
  ...
  // A Bot Mode bot: the roster shows ui_meta['nastech-bots'].title.
  seedProfile(sandbox.nastechHome, mock.url, 'alpha', 'ui_meta:\n  nastech-bots:\n    title: Atlas Prime\n')
  // A renamed profile: `nastech profile rename` writes display_name.
  seedProfile(sandbox.nastechHome, mock.url, 'beta', 'display_name: Beacon\n')
