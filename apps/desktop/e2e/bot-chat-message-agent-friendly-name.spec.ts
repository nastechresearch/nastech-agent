...
test.beforeAll(async () => {
  ...
  seedWriterProfile(fixture.sandbox.nastechHome)
...
test('a DM addressed by the friendly name lands in that bot\'s Bot Chat', async () => {
  ...
  const home = fixture!.sandbox.nastechHome
  ...
  // The recipient turn is a full `nastech -p writer` CLI boot in the background; its
