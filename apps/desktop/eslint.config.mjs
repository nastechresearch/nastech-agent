...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @nastech/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@nastech/shared'],
              message: 'Plugins import only @nastech/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
