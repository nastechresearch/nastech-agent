/**
 * Raw palette table for every built-in Nastech theme preset — the single source
 ...
 *
 * The palette-bearing presets (nastech, github, catppuccin, everforest, solarized)
 ...
 * than hand-editing hexes. `nastech-alt` is first-party — do not re-derive it.
 */
