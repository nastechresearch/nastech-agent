  ...
  return (
    <div className="nastech-fade-in flex h-full flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {showLogs && (
          <div className="flex w-1/2 flex-col border-l border-(--stroke-nastech)">
            <div className="flex shrink-0 items-center justify-between border-b border-(--stroke-nastech) px-3 py-2 text-xs">
      ...
      <div className="flex shrink-0 items-center justify-between border-t border-(--stroke-nastech) px-6 py-3">
        <button
