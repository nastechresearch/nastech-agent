...
load_nastech_dotenv(nastech_home=get_nastech_home(), project_env=Path(__file__).parent / ".env")
...
_PROVIDER_HOSTS: Tuple[Tuple[str, str], ...] = (
    ("openrouter.ai", "openrouter"), ("nastechresearch.github.io", "nastech"), ("z.ai", "zai"), ("moonshot.ai", "kimi-coding"),
...
class TrajectoryCompressor:
    ...
    def _init_summarizer(self):
        ...
        if provider:
            ...
            if client is None:
                raise RuntimeError(f"Provider '{provider}' is not configured. Check your API key or run: nastech setup")
